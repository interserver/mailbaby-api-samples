...
# Unit tests for OpenAPIClient::EmailAddressParam
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe OpenAPIClient::EmailAddressParam do

  describe "test an instance of EmailAddressParam" do
    skip "should create an instance of EmailAddressParam" do
      #instance = OpenAPIClient::EmailAddressParam.new
      #expect(instance).to be_instance_of(OpenAPIClient::EmailAddressParam)
    end
  end
