...
class HistoryApi(baseUrl: String) {
   ...
   *   apiKeyAuth (apiKey)
   */
  def getStats(apiKey: String)(
): Request[Either[ResponseException[String, Exception], Seq[GetStats200ResponseInner]], Any] =
    basicRequest
