...
/**
 * rawMail - parameters interface
 */
export interface IRawMailParams {
...
export class SendingApi extends Api {
   ...
   * @param params.sendMailRaw 
   */
  async rawMail(params: IRawMailParams): Promise<GenericResponse> {
    // Verify required parameters are set
    this.ensureParamIsSet('rawMail', params, 'sendMailRaw');

    // Create URL to call
    const url = `${this.basePath}/mail/rawsend`;
    ...
    const response = await this.httpClient.createRequest(url)
      ...
      .withContent(JSON.stringify(params['sendMailRaw'] || {}))
   ...
   * @param params.body The email body.  If the string contains any HTML tags the message is automatically sent as &#x60;text/html&#x60;; otherwise it is sent as &#x60;text/plain&#x60;.
   * @param params.from 
   * @param params.to 
   * @param params.replyto 
   * @param params.cc 
   * @param params.bcc 
   * @param params.attachments Optional list of file attachments.  Each file must be base64-encoded. Include &#x60;filename&#x60; so recipients see a meaningful attachment name.
   * @param params.id Optional numeric ID of the mail order to send through.  If omitted the first active order on your account is used automatically.  Valid IDs are returned by &#x60;GET /mail&#x60;.
   */
   ...
   * @param params.to 
   * @param params.from The sender address.  This is used as both the &#x60;From&#x60; header and the &#x60;Reply-To&#x60; header automatically.  Must be a valid email address authorized for your mail order.
   * @param params.subject The subject line of the email.
   * @param params.body The email body.  If the string contains any HTML tags the message is automatically sent as &#x60;text/html&#x60;; otherwise it is sent as &#x60;text/plain&#x60;.
   * @param params.id Optional numeric ID of the mail order to send through.  If omitted the first active order on your account is used automatically.  Valid IDs are returned by &#x60;GET /mail&#x60;.
   */
