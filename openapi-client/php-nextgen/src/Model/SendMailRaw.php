...
class SendMailRaw implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SendMailRaw';
    ...
    {
        $this->setIfExists('raw_email', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if ($this->container['raw_email'] === null) {
            $invalidProperties[] = "'raw_email' can't be null";
        }
    ...
    {
        return $this->container['raw_email'];
    }

    /**
     * Sets raw_email
     *
     * @param string $raw_email The complete RFC 822 email message including all headers and the body. Must include at minimum `From`, `To`, `Subject`, `Date`, and `MIME-Version` headers.  DKIM signatures in the `DKIM-Signature` header are transmitted verbatim and will pass verification at the destination.
     *
     * @return $this
     */
    public function setRawEmail(string $raw_email): static
    {
        if (is_null($raw_email)) {
            throw new InvalidArgumentException('non-nullable raw_email cannot be null');
        }
        $this->container['raw_email'] = $raw_email;
