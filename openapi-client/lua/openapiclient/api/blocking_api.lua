...
local openapiclient_email_address_param = require "openapiclient.model.email_address_param"
...
function blocking_api:delist_block(email_address_param)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
	...
	req:set_body(dkjson.encode(email_address_param))
