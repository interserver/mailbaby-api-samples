...
type SendMailRaw* = object
  ...
  id*: Option[int64] ## Optional numeric ID of the mail order to use for SMTP authentication. If omitted the first active order on your account is used.  Valid IDs are returned by `GET /mail`.
