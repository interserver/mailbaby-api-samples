...
class OPENAPI_API OpenAPIServicesApi
{
public:
	OpenAPIServicesApi();
	~OpenAPIServicesApi();
	...
	* See also: Request::SetShouldRetry */
	...
	class GetMailOrderByIdRequest;
	class GetMailOrderByIdResponse;
	class GetMailOrdersRequest;
	class GetMailOrdersResponse;
	
    DECLARE_DELEGATE_OneParam(FGetMailOrderByIdDelegate, const GetMailOrderByIdResponse&);
    DECLARE_DELEGATE_OneParam(FGetMailOrdersDelegate, const GetMailOrdersResponse&);
    
    FHttpRequestPtr GetMailOrderById(const GetMailOrderByIdRequest& Request, const FGetMailOrderByIdDelegate& Delegate = FGetMailOrderByIdDelegate()) const;
...
private:
    void OnGetMailOrderByIdResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FGetMailOrderByIdDelegate Delegate) const;
