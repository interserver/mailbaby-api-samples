...
Describe -tag 'PSOpenAPITools' -name 'EmailAddressParam' {
    Context 'EmailAddressParam' {
        It 'Initialize-EmailAddressParam' {
            # a simple test to create an object
            #$NewObject = Initialize-EmailAddressParam -Email "TEST_VALUE"
            #$NewObject | Should -BeOfType EmailAddressParam
