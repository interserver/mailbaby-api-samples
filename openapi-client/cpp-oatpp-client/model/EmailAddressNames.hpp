...
#ifndef EmailAddressNames_H_
#define EmailAddressNames_H_
 ...
 */
class EmailAddressNames : public oatpp::DTO {

  DTO_INIT(EmailAddressNames, DTO /* Extends */)
