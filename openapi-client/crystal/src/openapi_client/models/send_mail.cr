...
module OpenAPIClient
  ...
  class SendMail
    ...
    # Required properties
    @[JSON::Field(key: "to", type: SendMailTo, nillable: false, emit_null: false)]
    property to : SendMailTo
    ...
    def initialize(@to : SendMailTo, @from : String, @subject : String, @body : String, @id : Int64? = nil)
    end
