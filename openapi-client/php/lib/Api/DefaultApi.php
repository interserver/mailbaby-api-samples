...
class DefaultApi
{
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\MailOrder[]|\OpenAPI\Client\Model\Error
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\MailOrder[]|\OpenAPI\Client\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\GenericResponse|\OpenAPI\Client\Model\Error|\OpenAPI\Client\Model\Error
     */
    public function sendMailById($id, $subject = null, $body = null, $to = null, $from = null)
    {
        list($response) = $this->sendMailByIdWithHttpInfo($id, $subject, $body, $to, $from);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\GenericResponse|\OpenAPI\Client\Model\Error|\OpenAPI\Client\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendMailByIdWithHttpInfo($id, $subject = null, $body = null, $to = null, $from = null)
    {
        $request = $this->sendMailByIdRequest($id, $subject, $body, $to, $from);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendMailByIdAsync($id, $subject = null, $body = null, $to = null, $from = null)
    {
        return $this->sendMailByIdAsyncWithHttpInfo($id, $subject, $body, $to, $from)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendMailByIdAsyncWithHttpInfo($id, $subject = null, $body = null, $to = null, $from = null)
    {
        $returnType = '\OpenAPI\Client\Model\GenericResponse';
        $request = $this->sendMailByIdRequest($id, $subject, $body, $to, $from);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function sendMailByIdRequest($id, $subject = null, $body = null, $to = null, $from = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
