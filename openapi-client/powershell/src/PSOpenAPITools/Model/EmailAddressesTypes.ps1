...
EmailAddressesTypes<PSCustomObject>
#>
function ConvertFrom-JsonToEmailAddressesTypes {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'String' defined in oneOf (EmailAddressesTypes). Proceeding to the next one if any."
        }
