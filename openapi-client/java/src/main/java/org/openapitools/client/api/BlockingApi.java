...
public class BlockingApi {
     ...
     */
    public okhttp3.Call delistBlockCall(EmailAddress emailAddress, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call delistBlockValidateBeforeCall(EmailAddress emailAddress, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'emailAddress' is set
        if (emailAddress == null) {
            throw new ApiException("Missing the required parameter 'emailAddress' when calling delistBlock(Async)");
        }

        return delistBlockCall(emailAddress, _callback);
     ...
     */
    public GenericResponse delistBlock(EmailAddress emailAddress) throws ApiException {
        ApiResponse<GenericResponse> localVarResp = delistBlockWithHttpInfo(emailAddress);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GenericResponse> delistBlockWithHttpInfo(EmailAddress emailAddress) throws ApiException {
        okhttp3.Call localVarCall = delistBlockValidateBeforeCall(emailAddress, null);
        Type localVarReturnType = new TypeToken<GenericResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call delistBlockAsync(EmailAddress emailAddress, final ApiCallback<GenericResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = delistBlockValidateBeforeCall(emailAddress, _callback);
        Type localVarReturnType = new TypeToken<GenericResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
