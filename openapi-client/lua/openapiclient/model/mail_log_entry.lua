...
local function new_mail_log_entry(_id, id, from, to, subject, message_id, created, time, user, transtype, origin, interface, sending_zone, body_size, seq, delivered, response, recipient, domain, locked, lock_time, assigned, queued, mx_hostname)
