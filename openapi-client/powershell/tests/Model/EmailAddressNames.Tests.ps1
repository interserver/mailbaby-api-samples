...
Describe -tag 'PSOpenAPITools' -name 'EmailAddressNames' {
    Context 'EmailAddressNames' {
        It 'Initialize-EmailAddressNames' {
            # a simple test to create an object
            #$NewObject = Initialize-EmailAddressNames
            #$NewObject | Should -BeOfType EmailAddressNames
