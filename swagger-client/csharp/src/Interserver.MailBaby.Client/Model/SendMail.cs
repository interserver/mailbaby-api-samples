...
namespace Interserver.MailBaby.Client.Model
{
        ...
        public partial class SendMail :  IEquatable<SendMail>, IValidatableObject
    {
        ...
        public SendMail(SendMailTo to = default(SendMailTo), string from = default(string), string subject = default(string), string body = default(string), long? id = default(long?))
        {
