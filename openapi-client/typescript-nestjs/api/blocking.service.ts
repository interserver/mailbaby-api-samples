...
export class BlockingService {
     ...
     */
    public delistBlock(emailAddressParam: EmailAddressParam, delistBlockOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<GenericResponse>>;
    public delistBlock(emailAddressParam: EmailAddressParam, delistBlockOpts?: { config?: AxiosRequestConfig }): Observable<any> {
