...
#ifndef MailBlockClickHouse_H_
#define MailBlockClickHouse_H_
 ...
 */
class MailBlockClickHouse : public oatpp::DTO {

  DTO_INIT(MailBlockClickHouse, DTO /* Extends */)
