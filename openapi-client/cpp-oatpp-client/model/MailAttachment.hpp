...
#ifndef MailAttachment_H_
#define MailAttachment_H_
 ...
 */
class MailAttachment : public oatpp::DTO {

  DTO_INIT(MailAttachment, DTO /* Extends */)

  DTO_FIELD(oatpp::String, filename);

  DTO_FIELD(std::string, data);
