...
Put the package under your project folder in a directory named `mailbaby` and add the following to `Cargo.toml` under `[dependencies]`:

```
mailbaby = { path = "./mailbaby" }
```
