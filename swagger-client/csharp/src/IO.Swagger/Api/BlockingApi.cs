...
namespace IO.Swagger.Api
{
        ...
        public interface IBlockingApi : IApiAccessor
    {
        ...
        /// <param name="body"></param>
        /// <returns>ApiResponse of GenericResponse</returns>
        ApiResponse<GenericResponse> DelistBlockWithHttpInfo (EmailAddress body);
        /// <summary>
        /// Removes an email address from the blocked list
        /// </summary>
        /// <remarks>
        ...
        /// <param name="body"></param>
        /// <returns>Task of GenericResponse</returns>
        System.Threading.Tasks.Task<GenericResponse> DelistBlockAsync (EmailAddress body);
        ...
        /// <param name="body"></param>
        /// <returns>Task of ApiResponse (GenericResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<GenericResponse>> DelistBlockAsyncWithHttpInfo (EmailAddress body);
        /// <summary>
        /// Removes an email address from the blocked list
        /// </summary>
        /// <remarks>
        ...
        public partial class BlockingApi : IBlockingApi
    {
        ...
        /// <param name="body"></param>
        /// <returns>ApiResponse of GenericResponse</returns>
        public ApiResponse< GenericResponse > DelistBlockWithHttpInfo (EmailAddress body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
        ...
        /// <param name="body"></param>
        /// <returns>Task of GenericResponse</returns>
        public async System.Threading.Tasks.Task<GenericResponse> DelistBlockAsync (EmailAddress body)
        {
        ...
        /// <param name="body"></param>
        /// <returns>Task of ApiResponse (GenericResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GenericResponse>> DelistBlockAsyncWithHttpInfo (EmailAddress body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling BlockingApi->DelistBlock");
