...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaResteasyEapServerCodegen", date = "2021-05-05T07:12:56.221955-04:00[America/New_York]")public interface MailApi  {
    ...
    Response sendMail(@Parameter(description = "" ,required=true) Body body,@Context SecurityContext securityContext);
