...
, @Parameter(in = ParameterIn.DEFAULT, description = "", required=true,schema=@Schema()) @RequestParam(value="data", required=true)  String data
    ...
    ResponseEntity<GenericResponse> deleteRule(@Parameter(in = ParameterIn.PATH, description = "The numeric ID of the deny rule to delete.  Obtain this from the `id` field in `GET /mail/rules` or the `text` field of a `POST /mail/rules` response.", required=true, schema=@Schema()) @PathVariable("ruleId") Integer ruleId
);
    ...
    @RequestMapping(value = "/mail/blocks/delete",
        ...
        method = RequestMethod.POST)
    ResponseEntity<GenericResponse> delistBlock(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody EmailAddressParam body
);
    ...
    @RequestMapping(value = "/mail/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<MailOrderDetail> getMailOrderById(@Parameter(in = ParameterIn.PATH, description = "The numeric ID of the mail order.", required=true, schema=@Schema()) @PathVariable("id") Long id
);
...
, defaultValue="1h")) @Valid @RequestParam(value = "time", required = false, defaultValue="1h") String time
    ...
    @RequestMapping(value = "/mail/rawsend",
        ...
        consumes = { "application/json", "multipart/form-data" }, 
        method = RequestMethod.POST)
    ResponseEntity<GenericResponse> rawMail(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema()) @Valid @RequestBody SendMailRaw body
);
...
, @Parameter(in = ParameterIn.DEFAULT, description = "", required=true,schema=@Schema()) @RequestParam(value="id", required=true)  Long id
    ...
    @RequestMapping(value = "/mail/send",
        ...
        consumes = { "application/x-www-form-urlencoded", "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<GenericResponse> sendMail(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true,schema=@Schema()) @RequestParam(value="to", required=true)  SendMailTo to
...
, @Parameter(in = ParameterIn.DEFAULT, description = "", required=true,schema=@Schema()) @RequestParam(value="id", required=true)  Long id
    ...
    @RequestMapping(value = "/mail/log",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<MailLog> viewMailLog(@Parameter(in = ParameterIn.QUERY, description = "The numeric ID of the mail order to filter by.  When omitted, logs from the first active mail order are returned.  Obtain valid IDs from `GET /mail` or `GET /mail/{id}`." ,schema=@Schema()) @Valid @RequestParam(value = "id", required = false) Long id
