...
export class HistoryService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public viewMailLog(id?: number, origin?: string, mx?: string, from?: string, to?: string, subject?: string, mailid?: string, messageId?: string, replyto?: string, headerfrom?: string, delivered?: number, skip?: number, limit?: number, startDate?: number, endDate?: number, observe?: 'body', reportProgress?: boolean): Observable<MailLog>;
    public viewMailLog(id?: number, origin?: string, mx?: string, from?: string, to?: string, subject?: string, mailid?: string, messageId?: string, replyto?: string, headerfrom?: string, delivered?: number, skip?: number, limit?: number, startDate?: number, endDate?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<MailLog>>;
    public viewMailLog(id?: number, origin?: string, mx?: string, from?: string, to?: string, subject?: string, mailid?: string, messageId?: string, replyto?: string, headerfrom?: string, delivered?: number, skip?: number, limit?: number, startDate?: number, endDate?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<MailLog>>;
    public viewMailLog(id?: number, origin?: string, mx?: string, from?: string, to?: string, subject?: string, mailid?: string, messageId?: string, replyto?: string, headerfrom?: string, delivered?: number, skip?: number, limit?: number, startDate?: number, endDate?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
