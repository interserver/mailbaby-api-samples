...
module OpenAPIClient
  ...
  class MailStatsVolume
    ...
    @[JSON::Field(key: "to", type: Hash(String, Int32)?, nillable: true, emit_null: false)]
    property to : Hash(String, Int32)?

    # Message counts keyed by sender (envelope `from`) email address.
    @[JSON::Field(key: "from", type: Hash(String, Int32)?, nillable: true, emit_null: false)]
    property from : Hash(String, Int32)?

    # Message counts keyed by originating client IP address.
    @[JSON::Field(key: "ip", type: Hash(String, Int32)?, nillable: true, emit_null: false)]
    property ip : Hash(String, Int32)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@to : Hash(String, Int32)? = nil, @from : Hash(String, Int32)? = nil, @ip : Hash(String, Int32)? = nil)
    end
