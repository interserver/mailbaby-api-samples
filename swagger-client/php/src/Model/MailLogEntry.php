...
class MailLogEntry implements ModelInterface, ArrayAccess
{
     ...
     * Sets subject
     *
     * @param string $subject The `Subject` header value, if available.
     *
     * @return $this
     */
     ...
     * Sets messageId
     *
     * @param string $messageId The `Message-ID` header value, if present.  Can be used with the `messageId` filter on `GET /mail/log` for subsequent lookups.
     *
     * @return $this
     */
     ...
     * Sets delivered
     *
     * @param int $delivered Delivery status flag.  `1` = successfully delivered to destination MX. `0` = queued, deferred, or failed.  `null` = delivery not yet attempted. Corresponds to the `delivered` filter parameter on `GET /mail/log`.
     *
     * @return $this
     */
     ...
     * Sets response
     *
     * @param string $response The SMTP response string received from the destination MX server upon delivery attempt (e.g. `\"250 2.0.0 Ok queued as C91D83E128C\"`).
     *
     * @return $this
     */
     ...
     * Sets domain
     *
     * @param string $domain The destination domain.  Corresponds to the `mx` filter parameter (which matches `mxHostname`, not `domain`) on `GET /mail/log`.
     *
     * @return $this
     */
     ...
     * Sets mxHostname
     *
     * @param string $mxHostname The MX hostname the relay connected to for delivery.  Corresponds to the `mx` filter parameter on `GET /mail/log`.
     *
     * @return $this
     */
