...
#' OneOfSendMailTo Class
#'
#'
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
OneOfSendMailTo <- R6::R6Class(
  'OneOfSendMailTo',
  public = list(
    initialize = function(){
    },
    toJSON = function() {
      OneOfSendMailToObject <- list()

      OneOfSendMailToObject
    },
    fromJSON = function(OneOfSendMailToJson) {
      OneOfSendMailToObject <- jsonlite::fromJSON(OneOfSendMailToJson)
    },
    ...
    fromJSONString = function(OneOfSendMailToJson) {
      OneOfSendMailToObject <- jsonlite::fromJSON(OneOfSendMailToJson)
    }
  )
)
