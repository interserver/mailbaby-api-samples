...
void OAIDefaultApi::initializeServerConfigs() {
    ...
    QMap<QString, OAIServerVariable>()));
    defaultConf.append(OAIServerConfiguration(
    QUrl("https://virtserver.swaggerhub.com/InterServer/Mail-Baby/1.0.0"),
...
void OAIDefaultApi::viewMailLog(const ::OpenAPI::OptionalParam<qint64> &id, const ::OpenAPI::OptionalParam<QString> &search, const ::OpenAPI::OptionalParam<qint32> &skip, const ::OpenAPI::OptionalParam<qint32> &limit, const ::OpenAPI::OptionalParam<qint64> &start_date, const ::OpenAPI::OptionalParam<qint64> &end_date) {
