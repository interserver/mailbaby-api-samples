...
MailStatsVolume<PSCustomObject>
#>

function Initialize-MailStatsVolume {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MailStatsVolume' | Write-Debug
...
Convert from JSON to MailStatsVolume<PSCustomObject>
...
MailStatsVolume<PSCustomObject>
#>
function ConvertFrom-JsonToMailStatsVolume {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MailStatsVolume' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MailStatsVolume
