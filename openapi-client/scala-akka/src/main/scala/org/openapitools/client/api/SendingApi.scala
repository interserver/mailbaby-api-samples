...
class SendingApi(baseUrl: String) {
   ...
   */
  def sendAdvMail(subject: String, body: String, from: EmailAddressTypes, to: EmailAddressesTypes, replyto: Option[EmailAddressesTypes] = None, cc: Option[EmailAddressesTypes] = None, bcc: Option[EmailAddressesTypes] = None, attachments: Seq[MailAttachment], id: Option[Long] = None)(implicit apiKey: ApiKeyValue): ApiRequest[GenericResponse] =
   ...
   * @param id Optional numeric ID of the mail order to send through.  If omitted the first active order on your account is used automatically.  Valid IDs are returned by `GET /mail`.
   */
  def sendMail(to: SendMailTo, from: String, subject: String, body: String, id: Option[Long] = None)(implicit apiKey: ApiKeyValue): ApiRequest[GenericResponse] =
