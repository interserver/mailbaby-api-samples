...
class DefaultApi(baseUrl: String) {
   ...
   */
  def viewMailLog(id: Option[Long] = None, search: Option[String] = None, skip: Option[Int] = None, limit: Option[Int] = None)(implicit apiKey: ApiKeyValue): ApiRequest[MailLog] =
