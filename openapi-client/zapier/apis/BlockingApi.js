...
const EmailAddressParam = require('../models/EmailAddressParam');
...
module.exports = {
    addRule: {
        ...
        operation: {
            inputFields: [
                ...
                {
                    key: 'data',
                    label: 'The value to match against, interpreted according to &#x60;type&#x60;: a full email address for &#x60;email&#x60;/&#x60;destination&#x60;, a domain name for &#x60;domain&#x60;, or an alphanumeric prefix string for &#x60;startswith&#x60;.',
                    type: 'string',
                    required: true,
                },
                {
                    key: 'user',
                    label: 'Optional SMTP username of the mail order to associate this rule with (e.g. &#x60;mb20682&#x60;).  If omitted the first active order is used.  Valid usernames are the &#x60;username&#x60; values returned by &#x60;GET /mail&#x60;.',
                    type: 'string',
                },
            ],
            outputFields: [
    ...
    deleteRule: {
        ...
        noun: 'Blocking',
        display: {
            label: 'Removes a deny mail rule',
        ...
        operation: {
            inputFields: [
                {
                    key: 'ruleId',
                    label: 'The numeric ID of the deny rule to delete.  Obtain this from the &#x60;id&#x60; field in &#x60;GET /mail/rules&#x60; or the &#x60;text&#x60; field of a &#x60;POST /mail/rules&#x60; response.',
                    type: 'integer',
                    required: true,
                },
            ],
        ...
        operation: {
            ...
            perform: async (z, bundle) => {
                const options = {
                    ...
                    body: {
                        ...EmailAddressParam.mapping(bundle),
                    },
                }
                return z.request(utils.requestOptionsMiddleware(z, bundle, options)).then((response) => {
                    response.throwForStatus();
