...
//
mail_order_detail_t*
ServicesAPI_getMailOrderById(apiClient_t *apiClient, long id)
{
    ...
    mail_order_detail_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *ServicesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = mail_order_detail_parseFromJSON(ServicesAPIlocalVarJSON);
