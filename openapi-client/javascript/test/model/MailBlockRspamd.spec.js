...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailBabyEmailDeliveryAndManagementServiceApi.MailBlockRspamd();
  });
  ...
  describe('MailBlockRspamd', function() {
    it('should create an instance of MailBlockRspamd', function() {
      ...
      //var instance = new MailBabyEmailDeliveryAndManagementServiceApi.MailBlockRspamd();
      //expect(instance).to.be.a(MailBabyEmailDeliveryAndManagementServiceApi.MailBlockRspamd);
    });
