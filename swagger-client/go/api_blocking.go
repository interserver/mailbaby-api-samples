...
/*
BlockingApiService Removes a deny mail rule
...
/*
BlockingApiService Removes an email address from the block lists
...
@return GenericResponse
*/
func (a *BlockingApiService) DelistBlock(ctx context.Context, body EmailAddressParam) (GenericResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
