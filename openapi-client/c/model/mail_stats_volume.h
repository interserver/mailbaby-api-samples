...
#ifndef _mail_stats_volume_H_
#define _mail_stats_volume_H_
...
typedef struct mail_stats_volume_t mail_stats_volume_t;




typedef struct mail_stats_volume_t {
    list_t* to; //map
    list_t* from; //map
    list_t* ip; //map
