...
namespace mailbaby-client-csharp.Api
{
        ...
        public interface ISendingApi : IApiAccessor
    {
        ...
        /// <param name="id"></param>
        /// <returns>ApiResponse of GenericResponse</returns>
        ApiResponse<GenericResponse> SendMailWithHttpInfo (Object to, string from, string subject, string body, long? id);
        /// <summary>
        /// Sends an Email
        /// </summary>
        /// <remarks>
        ...
        /// <param name="id"></param>
        /// <returns>Task of GenericResponse</returns>
        System.Threading.Tasks.Task<GenericResponse> SendMailAsync (Object to, string from, string subject, string body, long? id);
        ...
        /// <param name="id"></param>
        /// <returns>Task of ApiResponse (GenericResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<GenericResponse>> SendMailAsyncWithHttpInfo (Object to, string from, string subject, string body, long? id);
        /// <summary>
        /// Sends an Email
        /// </summary>
        /// <remarks>
        ...
        public partial class SendingApi : ISendingApi
    {
        ...
        /// <returns></returns>
        public SendingApi(mailbaby-client-csharp.Client.Configuration configuration = null)
        {
        ...
        /// <param name="id"></param>
        /// <returns>ApiResponse of GenericResponse</returns>
        public ApiResponse< GenericResponse > SendMailWithHttpInfo (Object to, string from, string subject, string body, long? id)
        {
            // verify the required parameter 'to' is set
            if (to == null)
        ...
        /// <param name="id"></param>
        /// <returns>Task of GenericResponse</returns>
        public async System.Threading.Tasks.Task<GenericResponse> SendMailAsync (Object to, string from, string subject, string body, long? id)
        {
        ...
        /// <param name="id"></param>
        /// <returns>Task of ApiResponse (GenericResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<GenericResponse>> SendMailAsyncWithHttpInfo (Object to, string from, string subject, string body, long? id)
        {
            // verify the required parameter 'to' is set
            if (to == null)
                throw new ApiException(400, "Missing required parameter 'to' when calling SendingApi->SendMail");
