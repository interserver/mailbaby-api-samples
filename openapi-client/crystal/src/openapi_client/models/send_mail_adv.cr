...
module 
  ...
  class SendMailAdv include JSON::Serializable
   include JSON::Serializable 
    ...
    @[JSON::Field(key: from, type: Array(SendMailAdvFrom))]
    property from : Array(SendMailAdvFrom)
    ...
    def initialize(@subject : String, @body : String, @from : Array(SendMailAdvFrom), @to : Array(MailContact), @id : Int64, @replyto : Array(MailContact) | Nil, @cc : Array(MailContact) | Nil, @bcc : Array(MailContact) | Nil, @attachments : Array(MailAttachment) | Nil)
    end
