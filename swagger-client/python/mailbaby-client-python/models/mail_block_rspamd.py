...
class MailBlockRspamd(object):
    ...
    def __init__(self, _from=None, subject=None):  # noqa: E501
        """MailBlockRspamd - a model defined in Swagger"""  # noqa: E501
        self.__from = None
        self._subject = None
    ...
    @property
    def subject(self):
        """Gets the subject of this MailBlockRspamd.  # noqa: E501

        The suspicious subject pattern that triggered the block.  # noqa: E501

        :return: The subject of this MailBlockRspamd.  # noqa: E501
        :rtype: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MailBlockRspamd, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MailBlockRspamd):
            return False
