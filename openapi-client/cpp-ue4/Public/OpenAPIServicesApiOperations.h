...
#include "OpenAPIMailOrderDetail.h"
...
*/
class OPENAPI_API OpenAPIServicesApi::GetMailOrderByIdRequest : public Request
{
public:
    virtual ~GetMailOrderByIdRequest() {}
...
class OPENAPI_API OpenAPIServicesApi::GetMailOrderByIdResponse : public Response
{
public:
    virtual ~GetMailOrderByIdResponse() {}
	void SetHttpResponseCode(EHttpResponseCodes::Type InHttpResponseCode) final;
	bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) final;

    OpenAPIMailOrderDetail Content;
};
