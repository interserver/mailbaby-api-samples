...
{ 
    ...
    { 
        ...
        public virtual IActionResult ViewMailLog([FromQuery]long? id, [FromQuery]string search, [FromQuery]int? skip, [FromQuery][Range(1, 10000)]int? limit, [FromQuery][Range(0, 9999999999)]long? startDate, [FromQuery][Range(0, 9999999999)]long? endDate)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
