...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OneOfSendMailTo', function() {
      beforeEach(function() {
        instance = new MailBabyEmailDeliveryAndManagementServiceApi.OneOfSendMailTo();
      });

      it('should create an instance of OneOfSendMailTo', function() {
        // TODO: update the code to test OneOfSendMailTo
        expect(instance).to.be.a(MailBabyEmailDeliveryAndManagementServiceApi.OneOfSendMailTo);
      });
