...
class SendingApi(baseUrl: String) {
   ...
   */
  def sendAdvMail(apiKey: String)(subject: String, body: String, from: EmailAddressName, to: Seq[EmailAddressName], replyto: Seq[EmailAddressName], cc: Seq[EmailAddressName], bcc: Seq[EmailAddressName], attachments: Seq[MailAttachment], id: Option[Long] = None): Request[Either[ResponseException[String, Exception], GenericResponse]] =
    basicRequest
