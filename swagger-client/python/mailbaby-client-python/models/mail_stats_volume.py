...
class MailStatsVolume(object):
    ...
    def __init__(self, to=None, _from=None, ip=None):  # noqa: E501
        """MailStatsVolume - a model defined in Swagger"""  # noqa: E501
        self._to = None
        self.__from = None
        self._ip = None
    ...
    @property
    def to(self):
        """Gets the to of this MailStatsVolume.  # noqa: E501

        Message counts keyed by destination (envelope `to`) email address.  # noqa: E501

        :return: The to of this MailStatsVolume.  # noqa: E501
        :rtype: dict(str, int)
        """
        return self._to
    ...
    @property
    def _from(self):
        """Gets the _from of this MailStatsVolume.  # noqa: E501

        Message counts keyed by sender (envelope `from`) email address.  # noqa: E501

        :return: The _from of this MailStatsVolume.  # noqa: E501
        :rtype: dict(str, int)
        """
        return self.__from
    ...
    @property
    def ip(self):
        """Gets the ip of this MailStatsVolume.  # noqa: E501

        Message counts keyed by originating client IP address.  # noqa: E501

        :return: The ip of this MailStatsVolume.  # noqa: E501
        :rtype: dict(str, int)
        """
        return self._ip
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MailStatsVolume, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MailStatsVolume):
            return False
