...
EmailAddressParam<PSCustomObject>
#>

function Initialize-EmailAddressParam {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EmailAddressParam' | Write-Debug
...
Convert from JSON to EmailAddressParam<PSCustomObject>
...
EmailAddressParam<PSCustomObject>
#>
function ConvertFrom-JsonToEmailAddressParam {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EmailAddressParam' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EmailAddressParam
        $AllProperties = ("email")
