...
package .Models is
   ...
   type MailLogEntry_Type is
     record
       ...
       P__lock : Swagger.UString;
       Logger : Swagger.UString;
       Mx_Port : Integer;
       Connection_Key : Swagger.UString;
       Mx_Hostname : Swagger.UString;
       Sent_Body_Hash : Swagger.UString;
       Sent_Body_Size : Integer;
       Md_5Match : Integer;
     end record;
