...
module SwaggerClient
  ...
  class MailLogEntry
    ...
    # transaction host
    attr_accessor :transhost

    # origin host
    attr_accessor :originhost
    ...
    # body hash
    attr_accessor :sent_body_hash

    # sent body size in bytes
    attr_accessor :sent_body_size

    # md5 checksum matching result
    attr_accessor :md5_match
    ...
    def self.openapi_types
      {
        ...
        :'mx_hostname' => :'Object',
        :'sent_body_hash' => :'Object',
        :'sent_body_size' => :'Object',
        :'md5_match' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'transhost')
        self.transhost = attributes[:'transhost']
      end

      if attributes.key?(:'originhost')
        self.originhost = attributes[:'originhost']
      end
      ...
      if attributes.key?(:'source_md5')
        self.source_md5 = attributes[:'source_md5']
      end
      ...
      if attributes.key?(:'_lock')
        self._lock = attributes[:'_lock']
      end
      ...
      if attributes.key?(:'mx_port')
        self.mx_port = attributes[:'mx_port']
      end

      if attributes.key?(:'connection_key')
        self.connection_key = attributes[:'connection_key']
      end
      ...
      if attributes.key?(:'sent_body_hash')
        self.sent_body_hash = attributes[:'sent_body_hash']
      end

      if attributes.key?(:'sent_body_size')
        self.sent_body_size = attributes[:'sent_body_size']
      end

      if attributes.key?(:'md5_match')
        self.md5_match = attributes[:'md5_match']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @transhost.nil?
        invalid_properties.push('invalid value for "transhost", transhost cannot be nil.')
      end

      if @originhost.nil?
        invalid_properties.push('invalid value for "originhost", originhost cannot be nil.')
      end
      ...
      if @source_md5.nil?
        invalid_properties.push('invalid value for "source_md5", source_md5 cannot be nil.')
      end
      ...
      if @_lock.nil?
        invalid_properties.push('invalid value for "_lock", _lock cannot be nil.')
      end
      ...
      if @mx_port.nil?
        invalid_properties.push('invalid value for "mx_port", mx_port cannot be nil.')
      end

      if @connection_key.nil?
        invalid_properties.push('invalid value for "connection_key", connection_key cannot be nil.')
      end
      ...
      if @sent_body_hash.nil?
        invalid_properties.push('invalid value for "sent_body_hash", sent_body_hash cannot be nil.')
      end

      if @sent_body_size.nil?
        invalid_properties.push('invalid value for "sent_body_size", sent_body_size cannot be nil.')
      end

      if @md5_match.nil?
        invalid_properties.push('invalid value for "md5_match", md5_match cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @_lock.nil?
      return false if @logger.nil?
      return false if @mx_port.nil?
      return false if @connection_key.nil?
      return false if @mx_hostname.nil?
      return false if @sent_body_hash.nil?
      return false if @sent_body_size.nil?
      return false if @md5_match.nil?
      true
    end
