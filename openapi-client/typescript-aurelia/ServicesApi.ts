...
/**
 * getMailOrderById - parameters interface
 */
export interface IGetMailOrderByIdParams {
  id: number;
}
...
export class ServicesApi extends Api {
   ...
   * @param params.id The numeric ID of the mail order.
   */
  async getMailOrderById(params: IGetMailOrderByIdParams): Promise<MailOrderDetail> {
    // Verify required parameters are set
    this.ensureParamIsSet('getMailOrderById', params, 'id');
