...
case class SendMailAdv (
  ...
  replyto: Option[List[SendMailAdv_replyto]] = None,
  cc: Option[List[SendMailAdv_cc]] = None,
  bcc: Option[List[SendMailAdv_bcc]] = None,
  attachments: Option[List[SendMailAdv_attachments]] = None,
  id: Option[Long] = None
)
