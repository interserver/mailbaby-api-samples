...
module.exports = {
    rawMail: {
        ...
        noun: 'Sending',
        display: {
            label: 'Sends a raw RFC 822 email',
    ...
    sendAdvMail: {
        ...
        operation: {
            inputFields: [
                ...
                {
                    key: 'body',
                    label: 'The email body.  If the string contains any HTML tags the message is automatically sent as &#x60;text/html&#x60;; otherwise it is sent as &#x60;text/plain&#x60;.',
                    type: 'string',
                    required: true,
                },
                ...
                {
                    key: 'attachments',
                    label: 'Optional list of file attachments.  Each file must be base64-encoded. Include &#x60;filename&#x60; so recipients see a meaningful attachment name.',
                    type: 'string',
                }
                {
                    key: 'id',
                    label: 'Optional numeric ID of the mail order to send through.  If omitted the first active order on your account is used automatically.  Valid IDs are returned by &#x60;GET /mail&#x60;.',
                    type: 'number',
                },
            ],
            outputFields: [
