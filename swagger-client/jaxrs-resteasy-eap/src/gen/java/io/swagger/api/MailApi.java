...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaResteasyEapServerCodegen", date = "2021-05-05T07:07:22.248437-04:00[America/New_York]")public interface MailApi  {
    ...
    Response sendMail(@Parameter(description = "" ,required=true) Body1 body,@Context SecurityContext securityContext);
