...
namespace Interserver.MailBaby.Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MailStatsVolume :  IEquatable<MailStatsVolume>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MailStatsVolume" /> class.
        /// </summary>
        ...
        public MailStatsVolume(Dictionary<string, int?> to = default(Dictionary<string, int?>), Dictionary<string, int?> from = default(Dictionary<string, int?>), Dictionary<string, int?> ip = default(Dictionary<string, int?>))
        {
            this.to = to;
            this.from = from;
            this.ip = ip;
        ...
        {
            return this.Equals(input as MailStatsVolume);
        }

        /// <summary>
        /// Returns true if MailStatsVolume instances are equal
        /// </summary>
        /// <param name="input">Instance of MailStatsVolume to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MailStatsVolume input)
        {
            if (input == null)
                return false;
