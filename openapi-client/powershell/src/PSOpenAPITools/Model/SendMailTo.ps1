...
SendMailTo<PSCustomObject>
#>
function ConvertFrom-JsonToSendMailTo {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            ...
            Write-Debug "Failed to match 'String' defined in oneOf (SendMailTo). Proceeding to the next one if any."
        }
