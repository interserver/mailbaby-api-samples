...
public abstract class MailApiService {
    ...
    public abstract Response delistBlock(EmailAddressParam body,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response getMailOrderById(Long id,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response rawMail(SendMailRaw body,SecurityContext securityContext) throws NotFoundException;
    public abstract Response rawMail(String rawEmail,Long id,SecurityContext securityContext) throws NotFoundException;
