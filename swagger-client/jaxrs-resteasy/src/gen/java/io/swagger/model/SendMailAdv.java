...
public class SendMailAdv   {
  private String subject = null;  private String body = null;  private EmailAddressName from = null;  private List<EmailAddressName> to = new ArrayList<EmailAddressName>();  private List<EmailAddressName> replyto = new ArrayList<EmailAddressName>();  private List<EmailAddressName> cc = new ArrayList<EmailAddressName>();  private List<EmailAddressName> bcc = new ArrayList<EmailAddressName>();  private List<MailAttachment> attachments = new ArrayList<MailAttachment>();  private Long id = null;
