...
*BlockingApi* | **deleteRule** | **DELETE** /mail/rules/${ruleIdPathParam} | Removes a deny mail rule
...
*ServicesApi* | **getMailOrderById** | **GET** /mail/${idPathParam} | Displays details for a single mail order
