...
module SwaggerClient
  class BlockingApi
    ...
    def add_rule_with_http_info(user, type, data, opts = {})
      ...
      # verify enum value
      if @api_client.config.client_side_validation && !['domain', 'email', 'startswith'].include?(type)
        fail ArgumentError, "invalid value for 'type', must be one of domain, email, startswith"
      end
