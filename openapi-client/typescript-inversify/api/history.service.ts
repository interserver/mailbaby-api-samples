...
export class HistoryService {
     ...
     */
    public getStats(time?: 'all' | 'billing' | 'month' | '7d' | '24h' | 'day' | '1h', observe?: 'body', headers?: Headers): Observable<MailStatsType>;
    public getStats(time?: 'all' | 'billing' | 'month' | '7d' | '24h' | 'day' | '1h', observe?: 'response', headers?: Headers): Observable<HttpResponse<MailStatsType>>;
    public getStats(time?: 'all' | 'billing' | 'month' | '7d' | '24h' | 'day' | '1h', observe: any = 'body', headers: Headers = {}): Observable<any> {
     ...
     */
    public viewMailLog(id?: number, origin?: string, mx?: string, from?: string, to?: string, subject?: string, mailid?: string, messageId?: string, replyto?: string, headerfrom?: string, delivered?: 0 | 1, skip?: number, limit?: number, startDate?: number, endDate?: number, observe?: 'body', headers?: Headers): Observable<MailLog>;
    public viewMailLog(id?: number, origin?: string, mx?: string, from?: string, to?: string, subject?: string, mailid?: string, messageId?: string, replyto?: string, headerfrom?: string, delivered?: 0 | 1, skip?: number, limit?: number, startDate?: number, endDate?: number, observe?: 'response', headers?: Headers): Observable<HttpResponse<MailLog>>;
    public viewMailLog(id?: number, origin?: string, mx?: string, from?: string, to?: string, subject?: string, mailid?: string, messageId?: string, replyto?: string, headerfrom?: string, delivered?: 0 | 1, skip?: number, limit?: number, startDate?: number, endDate?: number, observe: any = 'body', headers: Headers = {}): Observable<any> {
        let queryParameters: string[] = [];
        if (id !== undefined) {
