 ...
 */
API.Client.DefaultApi.prototype.viewMailLog = function(opt_id, opt_origin, opt_mx, opt_from, opt_to, opt_subject, opt_mailid, opt_skip, opt_limit, opt_startDate, opt_endDate, opt_extraHttpRequestParams) {
  /** @const {string} */
