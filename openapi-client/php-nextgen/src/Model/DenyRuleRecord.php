...
class DenyRuleRecord implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DenyRuleRecord';
    ...
    */
     ...
     * Sets user
     *
     * @param string|null $user Mail account username that will be tied to this rule.  If not specified the first active mail order will be used.
     *
     * @return $this
     */
