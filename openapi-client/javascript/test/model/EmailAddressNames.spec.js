...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailBabyEmailDeliveryAndManagementServiceApi.EmailAddressNames();
  });
  ...
  describe('EmailAddressNames', function() {
    it('should create an instance of EmailAddressNames', function() {
      // uncomment below and update the code to test EmailAddressNames
      //var instance = new MailBabyEmailDeliveryAndManagementServiceApi.EmailAddressNames();
      //expect(instance).to.be.a(MailBabyEmailDeliveryAndManagementServiceApi.EmailAddressNames);
    });
