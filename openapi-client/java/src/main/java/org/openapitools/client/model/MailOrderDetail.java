...
public class MailOrderDetail {
  ...
  public MailOrderDetail() {
  }

  public MailOrderDetail id(@javax.annotation.Nonnull Integer id) {
    this.id = id;
    return this;
  }
  ...
  public MailOrderDetail status(@javax.annotation.Nonnull String status) {
    this.status = status;
    return this;
  }
  ...
  public MailOrderDetail username(@javax.annotation.Nonnull String username) {
  ...
  public MailOrderDetail password(@javax.annotation.Nonnull String password) {
  ...
  public MailOrderDetail comment(@javax.annotation.Nullable String comment) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("id", "status", "username", "password", "comment"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("id", "status", "username", "password"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MailOrderDetail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MailOrderDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MailOrderDetail is not found in the empty JSON string", MailOrderDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MailOrderDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MailOrderDetail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MailOrderDetail.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MailOrderDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MailOrderDetail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MailOrderDetail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MailOrderDetail.class));

       return (TypeAdapter<T>) new TypeAdapter<MailOrderDetail>() {
           @Override
           public void write(JsonWriter out, MailOrderDetail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MailOrderDetail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MailOrderDetail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MailOrderDetail
   * @throws IOException if the JSON string is invalid with respect to MailOrderDetail
   */
  public static MailOrderDetail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MailOrderDetail.class);
  }

  /**
   * Convert an instance of MailOrderDetail to an JSON string
   *
   * @return JSON string
   */
