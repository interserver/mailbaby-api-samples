...
#
package OpenAPIClient::Object::MailStatsTypeVolume;
...
__PACKAGE__->class_documentation({description => 'Top-500 breakdown of message counts grouped by source IP, destination address, and sender address within the selected &#x60;time&#x60; window.',
