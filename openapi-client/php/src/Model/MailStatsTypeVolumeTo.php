...
class MailStatsTypeVolumeTo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MailStatsType_volume_to';
    ...
    protected static array $openAPINullables = [
        'clientdomainCom' => false,
        'usersiteNet' => false,
        'salescompanyCom' => false,
        'clientanothersiteCom' => false
    ];
    ...
    {
        $this->setIfExists('clientdomainCom', $data ?? [], null);
        $this->setIfExists('usersiteNet', $data ?? [], null);
        $this->setIfExists('salescompanyCom', $data ?? [], null);
        $this->setIfExists('clientanothersiteCom', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param int|null $clientdomainCom clientdomainCom
     *
     * @return self
     */
    public function setClientdomainCom($clientdomainCom)
    {
        if (is_null($clientdomainCom)) {
            throw new \InvalidArgumentException('non-nullable clientdomainCom cannot be null');
        }
     ...
     * Sets usersiteNet
     *
     * @param int|null $usersiteNet usersiteNet
     *
     * @return self
     */
    public function setUsersiteNet($usersiteNet)
    {
        if (is_null($usersiteNet)) {
            throw new \InvalidArgumentException('non-nullable usersiteNet cannot be null');
        }
     ...
     *
     * @param int|null $salescompanyCom salescompanyCom
     *
     * @return self
     */
    public function setSalescompanyCom($salescompanyCom)
    {
        if (is_null($salescompanyCom)) {
            throw new \InvalidArgumentException('non-nullable salescompanyCom cannot be null');
        }
     ...
     *
     * @param int|null $clientanothersiteCom clientanothersiteCom
     *
     * @return self
     */
    public function setClientanothersiteCom($clientanothersiteCom)
    {
        if (is_null($clientanothersiteCom)) {
            throw new \InvalidArgumentException('non-nullable clientanothersiteCom cannot be null');
        }
