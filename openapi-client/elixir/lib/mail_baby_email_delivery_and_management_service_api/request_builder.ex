...
defmodule MailBabyEmailDeliveryAndManagementServiceAPI.RequestBuilder do
  @moduledoc """
  ...
  defp decode(%Tesla.Env{body: body}, %{}) do
    MailBabyEmailDeliveryAndManagementServiceAPI.Deserializer.json_decode(body)
  end

  defp decode(%Tesla.Env{body: body}, module) do
    MailBabyEmailDeliveryAndManagementServiceAPI.Deserializer.json_decode(body, module)
  end
end
