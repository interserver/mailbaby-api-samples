...
QString OAIBody::getTo() const {
    return to;
}
void OAIBody::setTo(const QString &to) {
    this->to = to;
    this->m_to_isSet = true;
}

bool OAIBody::is_to_Set() const{
    return m_to_isSet;
}

bool OAIBody::is_to_Valid() const{
    return m_to_isValid;
}

QString OAIBody::getFrom() const {
    return from;
}
void OAIBody::setFrom(const QString &from) {
    this->from = from;
    this->m_from_isSet = true;
}

bool OAIBody::is_from_Set() const{
    return m_from_isSet;
}

bool OAIBody::is_from_Valid() const{
    return m_from_isValid;
}

QString OAIBody::getSubject() const {
    return subject;
}
void OAIBody::setSubject(const QString &subject) {
    this->subject = subject;
    this->m_subject_isSet = true;
}

bool OAIBody::is_subject_Set() const{
    return m_subject_isSet;
}

bool OAIBody::is_subject_Valid() const{
