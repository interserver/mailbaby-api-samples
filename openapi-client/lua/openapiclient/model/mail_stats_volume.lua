...
-- mail_stats_volume class
local mail_stats_volume = {}
local mail_stats_volume_mt = {
	__name = "mail_stats_volume";
	__index = mail_stats_volume;
}

local function cast_mail_stats_volume(t)
	return setmetatable(t, mail_stats_volume_mt)
end

local function new_mail_stats_volume(to, from, ip)
	return cast_mail_stats_volume({
		["to"] = to;
		["from"] = from;
		["ip"] = ip;
	})
...
return {
	cast = cast_mail_stats_volume;
	new = new_mail_stats_volume;
}
