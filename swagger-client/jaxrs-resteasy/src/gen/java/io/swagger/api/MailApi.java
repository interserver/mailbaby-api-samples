...
public class MailApi  {
    ...
    throws NotFoundException {
        return service.addRule(user,type,data,securityContext);
    }
    @POST
    @Path("/rules")
    @Consumes({ "application/x-www-form-urlencoded", "application/json" })
...
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.addRule(body,securityContext);
    }
    @DELETE
    @Path("/rules/{ruleId}")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "404", description = "The specified resource was not found or does not belong to your account.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorMessage.class))) })
    public Response deleteRule( @PathParam("ruleId") Integer ruleId,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.deleteRule(ruleId,securityContext);
    }
    @POST
    @Path("/blocks/delete")
...
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.delistBlock(body,securityContext);
    }
    @POST
    @Path("/blocks/delete")
    @Consumes({ "application/json", "multipart/form-data" })
    ...
    throws NotFoundException {
        return service.delistBlock(email,securityContext);
    }
    @GET
    @Path("/blocks")
    ...
    throws NotFoundException {
        return service.getMailBlocks(securityContext);
    }
    @GET
    @Path("/{id}")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "404", description = "The specified resource was not found or does not belong to your account.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorMessage.class))) })
    public Response getMailOrderById( @PathParam("id") Long id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getMailOrderById(id,securityContext);
    }
    @GET
    ...
    throws NotFoundException {
        return service.getRules(securityContext);
    }
    @GET
    @Path("/stats")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Authentication failed.  Ensure you are sending a valid `X-API-KEY` header. Obtain your API key from [my.interserver.net/account_security](https://my.interserver.net/account_security).", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorMessage.class))) })
    public Response getStats(  @DefaultValue("1h") @QueryParam("time") String time,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getStats(time,securityContext);
    }
    @POST
    @Path("/rawsend")
    @Consumes({ "application/json", "multipart/form-data" })
...
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.rawMail(body,securityContext);
    }
    @POST
    @Path("/rawsend")
    @Consumes({ "application/json", "multipart/form-data" })
    ...
    throws NotFoundException {
        return service.rawMail(rawEmail,id,securityContext);
    }
    @POST
    @Path("/advsend")
    @Consumes({ "application/x-www-form-urlencoded", "application/json" })
...
,@Context SecurityContext securityContext)
    ...
    throws NotFoundException {
        return service.viewMailLog(id,origin,mx,from,to,subject,mailid,messageId,replyto,headerfrom,delivered,skip,limit,startDate,endDate,securityContext);
    }
}
