...
Protected Class SendingApi
	#tag Method, Flags = &h0
		Sub SendAdvMail(, subject As String, body As String, from As OpenAPIClient.Models.EmailAddressName, Escapedto() As OpenAPIClient.Models.EmailAddressName, replyto() As OpenAPIClient.Models.EmailAddressName, cc() As OpenAPIClient.Models.EmailAddressName, bcc() As OpenAPIClient.Models.EmailAddressName, attachments() As OpenAPIClient.Models.MailAttachment, Optional id As Xoson.O.OptionalInt64)
		  ...
		  // - parameter from: (form)  
		  // - parameter Escapedto: (form) A list of destionation email addresses to send this to 
		  // - parameter replyto: (form) (optional) A list of email addresses that specify where replies to the email should be sent instead of the _from_ address. (optional, default to Nil)
		  // - parameter cc: (form) (optional) A list of email addresses to carbon copy this message to.  They are listed on the email and anyone getting the email can see this full list of Contacts who received the email as well. (optional, default to Nil)
		  // - parameter bcc: (form) (optional) list of email addresses that should receive copies of the email.  They are hidden on the email and anyone gettitng the email would not see the other people getting the email in this list. (optional, default to Nil)
