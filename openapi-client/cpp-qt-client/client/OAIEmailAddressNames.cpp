...
OAIEmailAddressNames::OAIEmailAddressNames(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIEmailAddressNames::OAIEmailAddressNames() {
    this->initializeModel();
}

OAIEmailAddressNames::~OAIEmailAddressNames() {}

void OAIEmailAddressNames::initializeModel() {

}

void OAIEmailAddressNames::fromJson(QString jsonString) {
...
void OAIEmailAddressNames::fromJsonObject(QJsonObject json) {

}

QString OAIEmailAddressNames::asJson() const {
...
QJsonObject OAIEmailAddressNames::asJsonObject() const {
    QJsonObject obj;
    return obj;
}

bool OAIEmailAddressNames::isSet() const {
...
bool OAIEmailAddressNames::isValid() const {
