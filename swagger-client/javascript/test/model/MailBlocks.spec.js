...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MailBlocks', function() {
      beforeEach(function() {
        instance = new MailBabyEmailDeliveryAndManagementServiceApi.MailBlocks();
      });

      it('should create an instance of MailBlocks', function() {
        // TODO: update the code to test MailBlocks
        expect(instance).to.be.a(MailBabyEmailDeliveryAndManagementServiceApi.MailBlocks);
      });
      ...
      it('should have the property mbtrap (base name: "mbtrap")', function() {
        // TODO: update the code to test the property mbtrap
        expect(instance).to.have.property('mbtrap');
        // expect(instance.mbtrap).to.be(expectedValueLiteral);
      });
