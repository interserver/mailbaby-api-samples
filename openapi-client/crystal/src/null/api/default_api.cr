...
module 
  class DefaultApi
    ...
    def send_mail_by_id(id : Int64, subject : String?, body : String?, to : String?, from : String?)
      data, _status_code, _headers = send_mail_by_id_with_http_info(id, subject, body, to, from)
      data
    end
    ...
    def send_mail_by_id_with_http_info(id : Int64, subject : String?, body : String?, to : String?, from : String?)
      if @api_client.config.debugging
