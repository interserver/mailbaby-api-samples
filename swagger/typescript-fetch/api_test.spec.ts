...
describe("DefaultApi", () => {
  ...
  test("sendAdvMailById", () => {
    ...
    const id: number = 789
    return expect(instance.sendAdvMailById(body, id, {})).resolves.toBe(null)
  })
  test("sendMailById", () => {
    const id: number = 789
    ...
    return expect(instance.sendMailById(id, subject, body, to, toName, from, fromName, {})).resolves.toBe(null)
  })
