...
public abstract class MailApiService {
    ...
    public abstract Response rawMail(String rawEmail,Integer id,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response sendMail(String to,String from,String subject,String body,Integer id,SecurityContext securityContext) throws NotFoundException;
