...
|------------ | ------------- | ------------- | -------------|
| **\_id** | **Integer** | Internal auto-increment database row ID.  Not meaningful outside the API. | [default to null] |
...
| **time** | **Integer** | Unix timestamp of message acceptance.  Corresponds to the &#x60;startDate&#x60; and &#x60;endDate&#x60; filter parameters on &#x60;GET /mail/log&#x60;. | [default to null] |
...
| **interface** | **String** | Relay interface name that accepted the message (e.g. &#x60;feeder&#x60;). | [default to null] |
...
| **bodySize** | **Integer** | Size of the message body in bytes. | [optional] [default to null] |
| **seq** | **Integer** | Sequence index of this recipient in a multi-recipient message. Starts at 1. | [optional] [default to null] |
| **delivered** | **Integer** | Delivery status flag.  &#x60;1&#x60; &#x3D; successfully delivered to destination MX. &#x60;0&#x60; &#x3D; queued, deferred, or failed.  &#x60;null&#x60; &#x3D; delivery not yet attempted. Corresponds to the &#x60;delivered&#x60; filter parameter on &#x60;GET /mail/log&#x60;. | [optional] [default to null] |
...
| **locked** | **Integer** | Whether the queue entry is currently locked for delivery processing. | [optional] [default to null] |
