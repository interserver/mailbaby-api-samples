...
class MailLogEntry {
    ...
    constructor(id, id, from, to, subject, messageId, created, time, user, transtype, transhost, originhost, origin, _interface, _date, sendingZone, bodySize, sourceMd5, seq, domain, recipient, locked, lockTime, assigned, queued, lock, logger, mxPort, connectionKey, mxHostname, sentBodyHash, sentBodySize, md5Match) { 
        ...
        MailLogEntry.initialize(this, id, id, from, to, subject, messageId, created, time, user, transtype, transhost, originhost, origin, _interface, _date, sendingZone, bodySize, sourceMd5, seq, domain, recipient, locked, lockTime, assigned, queued, lock, logger, mxPort, connectionKey, mxHostname, sentBodyHash, sentBodySize, md5Match);
    }
     ...
     */
    static initialize(obj, id, id, from, to, subject, messageId, created, time, user, transtype, transhost, originhost, origin, _interface, _date, sendingZone, bodySize, sourceMd5, seq, domain, recipient, locked, lockTime, assigned, queued, lock, logger, mxPort, connectionKey, mxHostname, sentBodyHash, sentBodySize, md5Match) { 
        obj['_id'] = id;
        obj['id'] = id;
        obj['from'] = from;
        obj['to'] = to;
