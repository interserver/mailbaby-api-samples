...
void
SendMailAdv_replyto_inner::__init()
{
	//email = std::string();
	//name = std::string();
}
...
void
SendMailAdv_replyto_inner::__cleanup()
{
	//if(email != NULL) {
	//
	//delete email;
...
void
SendMailAdv_replyto_inner::fromJson(char* jsonStr)
{
...
SendMailAdv_replyto_inner::SendMailAdv_replyto_inner(char* json)
{
	this->fromJson(json);
}
