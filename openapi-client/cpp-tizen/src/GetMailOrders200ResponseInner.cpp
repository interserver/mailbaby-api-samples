...
void
GetMailOrders_200_response_inner::__init()
{
	//id = int(0);
	//status = std::string();
	//username = std::string();
...
void
GetMailOrders_200_response_inner::__cleanup()
{
	//if(id != NULL) {
	//
	//delete id;
...
void
GetMailOrders_200_response_inner::fromJson(char* jsonStr)
{
...
GetMailOrders_200_response_inner::GetMailOrders_200_response_inner(char* json)
{
	this->fromJson(json);
}
