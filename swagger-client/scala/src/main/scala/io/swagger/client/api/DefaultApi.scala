...
class DefaultApi(
   ...
   * @return MailLog
   */
  def viewMailLog(id: Option[Long] = None, search: Option[String] = None, skip: Option[Integer] = Option(0), limit: Option[Integer] = Option(100), startDate: Option[Long] = None, endDate: Option[Long] = None): Option[MailLog] = {
    val await = Try(Await.result(viewMailLogAsync(id, search, skip, limit, startDate, endDate), Duration.Inf))
    await match {
      case Success(i) => Some(await.get)
      case Failure(t) => None
    }
   ...
   */
  def viewMailLogAsync(id: Option[Long] = None, search: Option[String] = None, skip: Option[Integer] = Option(0), limit: Option[Integer] = Option(100), startDate: Option[Long] = None, endDate: Option[Long] = None): Future[MailLog] = {
      helper.viewMailLog(id, search, skip, limit, startDate, endDate)
  }
...
class DefaultApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def viewMailLog(id: Option[Long] = None,
    ...
    search match {
      case Some(param) => queryParams += "search" -> param.toString
      case _ => queryParams
    }
    skip match {
