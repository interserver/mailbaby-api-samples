...
import io.swagger.client.models.MailOrderDetail
...
class ServicesApi(basePath: kotlin.String = "https://api.mailbaby.net") : ApiClient(basePath) {
    ...
    fun getMailOrderById(id: kotlin.Long): MailOrderDetail {
        ...
        val response = request<MailOrderDetail>(
                localVariableConfig
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as MailOrderDetail
     ...
     * @return kotlin.Array<MailOrder>
     */
    @Suppress("UNCHECKED_CAST")
    fun getMailOrders(): kotlin.Array<MailOrder> {
        val localVariableConfig = RequestConfig(
                RequestMethod.GET,
                "/mail"
        )
        val response = request<kotlin.Array<MailOrder>>(
                localVariableConfig
        )

        return when (response.responseType) {
            ResponseType.Success -> (response as Success<*>).data as kotlin.Array<MailOrder>
            ResponseType.Informational -> TODO()
            ResponseType.Redirection -> TODO()
            ResponseType.ClientError -> throw ClientException((response as ClientError<*>).body as? String ?: "Client error")
            ResponseType.ServerError -> throw ServerException((response as ServerError<*>).message ?: "Server error")
