...
Describe -tag 'PSOpenAPITools' -name 'DefaultApi' {
    ...
    Context 'Invoke-ViewMailLog' {
        It 'Test Invoke-ViewMailLog' {
            #$TestResult = Invoke-ViewMailLog -Id "TEST_VALUE" -Origin "TEST_VALUE" -Mx "TEST_VALUE" -From "TEST_VALUE" -To "TEST_VALUE" -Subject "TEST_VALUE" -Mailid "TEST_VALUE" -Skip "TEST_VALUE" -Limit "TEST_VALUE" -StartDate "TEST_VALUE" -EndDate "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
