...
class DefaultApi(object):
    ...
    def send_adv_mail(self, subject, body, _from, to, replyto, cc, bcc, attachments, id, **kwargs):  # noqa: E501
        ...
        :param SendMailAdvFrom _from: (required)
        :param list[SendMailAdvTo] to: (required)
        :param list[SendMailAdvReplyto] replyto: (required)
        :param list[SendMailAdvCc] cc: (required)
        :param list[SendMailAdvBcc] bcc: (required)
        :param list[SendMailAdvAttachments] attachments: (required)
    ...
    def view_mail_log(self, **kwargs):  # noqa: E501
        ...
        :param str search: pass an optional search string for looking up inventory
    ...
    def view_mail_log_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'search', 'skip', 'limit', 'start_date', 'end_date']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
