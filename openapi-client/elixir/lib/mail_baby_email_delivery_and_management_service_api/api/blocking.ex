...
defmodule MailBabyEmailDeliveryAndManagementServiceAPI.Api.Blocking do
  ...
  """
  @spec add_rule(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, MailBabyEmailDeliveryAndManagementServiceAPI.Model.GetMailOrders401Response.t} | {:ok, MailBabyEmailDeliveryAndManagementServiceAPI.Model.GenericResponse.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec delete_rule(Tesla.Env.client, integer(), keyword()) :: {:ok, MailBabyEmailDeliveryAndManagementServiceAPI.Model.GetMailOrders401Response.t} | {:ok, MailBabyEmailDeliveryAndManagementServiceAPI.Model.GenericResponse.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec delist_block(Tesla.Env.client, MailBabyEmailDeliveryAndManagementServiceAPI.Model.EmailAddress.t, keyword()) :: {:ok, MailBabyEmailDeliveryAndManagementServiceAPI.Model.GetMailOrders401Response.t} | {:ok, MailBabyEmailDeliveryAndManagementServiceAPI.Model.GenericResponse.t} | {:error, Tesla.Env.t}
  def delist_block(connection, email_address, _opts \\ []) do
    request =
      %{}
      |> method(:post)
      |> url("/mail/blocks/delete")
      |> add_param(:body, :body, email_address)
      |> Enum.into([])
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_mail_blocks(Tesla.Env.client, keyword()) :: {:ok, MailBabyEmailDeliveryAndManagementServiceAPI.Model.GetMailOrders401Response.t} | {:ok, MailBabyEmailDeliveryAndManagementServiceAPI.Model.MailBlocks.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_rules(Tesla.Env.client, keyword()) :: {:ok, list(MailBabyEmailDeliveryAndManagementServiceAPI.Model.DenyRuleRecord.t)} | {:ok, MailBabyEmailDeliveryAndManagementServiceAPI.Model.GetMailOrders401Response.t} | {:error, Tesla.Env.t}
