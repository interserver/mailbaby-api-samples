...
#ifndef OAISendMail_to_H
#define OAISendMail_to_H
...
class OAISendMail_to : public OAIObject {
public:
    OAISendMail_to();
    OAISendMail_to(QString json);
    ~OAISendMail_to() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendMail_to)

#endif // OAISendMail_to_H
