...
class DefaultApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun sendMailById(id: kotlin.Long, subject: kotlin.String?, body: kotlin.String?, to: kotlin.String?, from: kotlin.String?) : GenericResponse {
        val localVariableConfig = sendMailByIdRequestConfig(id = id, subject = subject, body = body, to = to, from = from)
    ...
    * @return RequestConfig
    */
    fun sendMailByIdRequestConfig(id: kotlin.Long, subject: kotlin.String?, body: kotlin.String?, to: kotlin.String?, from: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
