 ...
 * @export
 * @interface EmailAddressNames
 */
export interface EmailAddressNames extends Array<EmailAddressName> {
}

/**
 * Check if a given object implements the EmailAddressNames interface.
 */
export function instanceOfEmailAddressNames(value: object): value is EmailAddressNames {
    return true;
}

export function EmailAddressNamesFromJSON(json: any): EmailAddressNames {
    return EmailAddressNamesFromJSONTyped(json, false);
}

export function EmailAddressNamesFromJSONTyped(json: any, ignoreDiscriminator: boolean): EmailAddressNames {
    return json;
}

export function EmailAddressNamesToJSON(json: any): EmailAddressNames {
    return EmailAddressNamesToJSONTyped(json, false);
}

export function EmailAddressNamesToJSONTyped(value?: EmailAddressNames | null, ignoreDiscriminator: boolean = false): any {
    return value;
}
