...
**id** | **char \*** | The numeric ID of the deny rule, as a string.  Pass this as &#x60;ruleId&#x60; to &#x60;DELETE /mail/rules/{ruleId}&#x60; to remove the rule. | 
**created** | **char \*** | The timestamp when the rule was created. | 
