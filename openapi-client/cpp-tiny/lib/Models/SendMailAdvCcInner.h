...
#ifndef TINY_CPP_CLIENT_SendMailAdv_cc_inner_H_
#define TINY_CPP_CLIENT_SendMailAdv_cc_inner_H_
...
class SendMailAdv_cc_inner{
public:

    /*! \brief Constructor.
	 */
    SendMailAdv_cc_inner();
    SendMailAdv_cc_inner(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_SendMailAdv_cc_inner_H_ */
