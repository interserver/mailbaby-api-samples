...
void OpenAPISendMailAdvAttachmentsInner::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPISendMailAdvAttachmentsInner::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
