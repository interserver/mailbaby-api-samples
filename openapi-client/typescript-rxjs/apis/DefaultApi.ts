...
export class DefaultApi extends BaseAPI {
     ...
     */
    viewMailLog({ id, search, skip, limit, startDate, endDate }: ViewMailLogRequest): Observable<MailLog>
    viewMailLog({ id, search, skip, limit, startDate, endDate }: ViewMailLogRequest, opts?: OperationOpts): Observable<AjaxResponse<MailLog>>
    viewMailLog({ id, search, skip, limit, startDate, endDate }: ViewMailLogRequest, opts?: OperationOpts): Observable<MailLog | AjaxResponse<MailLog>> {
