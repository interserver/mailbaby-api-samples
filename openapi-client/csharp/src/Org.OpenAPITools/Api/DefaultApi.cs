...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IDefaultApi : IApiAccessor
    {
        ...
        MailLog ViewMailLog (long? id = default(long?), string search = default(string), int? skip = default(int?), int? limit = default(int?), long? startDate = default(long?), long? endDate = default(long?));
        ...
        ApiResponse<MailLog> ViewMailLogWithHttpInfo (long? id = default(long?), string search = default(string), int? skip = default(int?), int? limit = default(int?), long? startDate = default(long?), long? endDate = default(long?));
        ...
        System.Threading.Tasks.Task<MailLog> ViewMailLogAsync (long? id = default(long?), string search = default(string), int? skip = default(int?), int? limit = default(int?), long? startDate = default(long?), long? endDate = default(long?), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<MailLog>> ViewMailLogWithHttpInfoAsync (long? id = default(long?), string search = default(string), int? skip = default(int?), int? limit = default(int?), long? startDate = default(long?), long? endDate = default(long?), CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class DefaultApi : IDefaultApi
    {
        ...
        /// <param name="endDate">earliest date to get emails in unix timestamp format (optional)</param>
        /// <returns>MailLog</returns>
        public MailLog ViewMailLog (long? id = default(long?), string search = default(string), int? skip = default(int?), int? limit = default(int?), long? startDate = default(long?), long? endDate = default(long?))
        {
        ...
        /// <param name="endDate">earliest date to get emails in unix timestamp format (optional)</param>
        /// <returns>ApiResponse of MailLog</returns>
        public ApiResponse<MailLog> ViewMailLogWithHttpInfo (long? id = default(long?), string search = default(string), int? skip = default(int?), int? limit = default(int?), long? startDate = default(long?), long? endDate = default(long?))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of MailLog</returns>
        public async System.Threading.Tasks.Task<MailLog> ViewMailLogAsync (long? id = default(long?), string search = default(string), int? skip = default(int?), int? limit = default(int?), long? startDate = default(long?), long? endDate = default(long?), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<MailLog> localVarResponse = await ViewMailLogWithHttpInfoAsync(id, search, skip, limit, startDate, endDate, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (MailLog)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<MailLog>> ViewMailLogWithHttpInfoAsync (long? id = default(long?), string search = default(string), int? skip = default(int?), int? limit = default(int?), long? startDate = default(long?), long? endDate = default(long?), CancellationToken cancellationToken = default(CancellationToken))
        {
