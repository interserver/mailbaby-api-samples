...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse401 :  IEquatable<InlineResponse401>, IValidatableObject
    {
        ...
        public InlineResponse401(string code = default(string), string message = default(string))
        {
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for InlineResponse401 and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            if (message == null)
            {
                throw new InvalidDataException("message is a required property for InlineResponse401 and cannot be null");
            }
            else
            {
