...
/*
 * OAIEmailAddressParam.h
 *
 * A single email address parameter used as the body of &#x60;POST /mail/blocks/delete&#x60;.
 */

#ifndef OAIEmailAddressParam_H
#define OAIEmailAddressParam_H
...
class OAIEmailAddressParam : public OAIObject {
public:
    OAIEmailAddressParam();
    OAIEmailAddressParam(QString json);
    ~OAIEmailAddressParam() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmailAddressParam)

#endif // OAIEmailAddressParam_H
