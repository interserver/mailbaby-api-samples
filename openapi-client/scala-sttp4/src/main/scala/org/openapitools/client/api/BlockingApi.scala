...
class BlockingApi(baseUrl: String) {
   ...
   */
  def addRule(apiKey: String)(`type`: String, data: String, user: Option[String] = None): Request[Either[ResponseException[String, Exception], GenericResponse]] =
    basicRequest
   ...
   */
  def deleteRule(apiKey: String)(ruleId: Int): Request[Either[ResponseException[String, Exception], GenericResponse]] =
    basicRequest
   ...
   * @param emailAddress 
   */
  def delistBlock(apiKey: String)(emailAddress: EmailAddress): Request[Either[ResponseException[String, Exception], GenericResponse]] =
    basicRequest
   ...
   *   apiKeyAuth (apiKey)
   */
  def getMailBlocks(apiKey: String)(): Request[Either[ResponseException[String, Exception], MailBlocks]] =
    basicRequest
   ...
   *   apiKeyAuth (apiKey)
   */
  def getRules(apiKey: String)(): Request[Either[ResponseException[String, Exception], Seq[DenyRuleRecord]]] =
    basicRequest
