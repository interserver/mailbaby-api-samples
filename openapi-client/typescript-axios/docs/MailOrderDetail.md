...
**password** | **string** | The current SMTP AUTH password for this mail order.  Use with the &#x60;username&#x60; field to authenticate against &#x60;relay.mailbaby.net:25&#x60;. | [default to undefined]
**comment** | **string** | Optional human-readable note associated with the order. | [optional] [default to undefined]

## Example

```typescript
import { MailOrderDetail } from './api';

const instance: MailOrderDetail = {
    id,
    status,
    username,
    password,
