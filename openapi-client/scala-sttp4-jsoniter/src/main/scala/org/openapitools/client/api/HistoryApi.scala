...
case class HistoryApi[Auth <: org.openapitools.client.core.Authorization] private (baseUrl: String, authConfig: org.openapitools.client.core.Authorization):
   ...
   */
  def viewMailLog(id: Option[Long] = scala.None, origin: Option[String] = scala.None, mx: Option[String] = scala.None, from: Option[String] = scala.None, to: Option[String] = scala.None, subject: Option[String] = scala.None, mailid: Option[String] = scala.None, messageId: Option[String] = scala.None, replyto: Option[String] = scala.None, headerfrom: Option[String] = scala.None, delivered: Option[Int] = scala.None, skip: Option[Int] = scala.None, limit: Option[Int] = scala.None, startDate: Option[Long] = scala.None, endDate: Option[Long] = scala.None)(using Auth <:< org.openapitools.client.core.Authorization.ApiKey): sttp.client4.Request[Either[ResponseException[String], MailLog]] =
    val requestURL =
      uri"$baseUrl/mail/log"
        ...
        .addParams(FormSerializable.serialize("messageId", messageId, FormStyleFormat.FORM, true): _*)
