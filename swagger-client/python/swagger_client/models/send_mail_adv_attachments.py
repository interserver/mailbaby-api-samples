...
class SendMailAdvAttachments(object):
    ...
    def __init__(self, filename=None, data=None):  # noqa: E501
        """SendMailAdvAttachments - a model defined in Swagger"""  # noqa: E501
        self._filename = None
        self._data = None
    ...
    @property
    def filename(self):
        """Gets the filename of this SendMailAdvAttachments.  # noqa: E501

        (optional) Filename to specify for the attachment.  # noqa: E501

        :return: The filename of this SendMailAdvAttachments.  # noqa: E501
        :rtype: str
        """
    ...
    @property
    def data(self):
        """Gets the data of this SendMailAdvAttachments.  # noqa: E501

        Contents of the attached file (must be base64 encoded)  # noqa: E501

        :return: The data of this SendMailAdvAttachments.  # noqa: E501
        :rtype: str
        """
        return self._data
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SendMailAdvAttachments, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SendMailAdvAttachments):
            return False
