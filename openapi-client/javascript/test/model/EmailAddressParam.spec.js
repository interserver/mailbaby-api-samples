...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailBabyEmailDeliveryAndManagementServiceApi.EmailAddressParam();
  });
  ...
  describe('EmailAddressParam', function() {
    it('should create an instance of EmailAddressParam', function() {
      // uncomment below and update the code to test EmailAddressParam
      //var instance = new MailBabyEmailDeliveryAndManagementServiceApi.EmailAddressParam();
      //expect(instance).to.be.a(MailBabyEmailDeliveryAndManagementServiceApi.EmailAddressParam);
    });
