...
class DefaultApi(baseUrl: String) {
   ...
   * @param from 
   */
  def sendMailById(id: Long, subject: Option[String] = None, body: Option[String] = None, to: Option[String] = None, from: Option[String] = None)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[GenericResponse] =
