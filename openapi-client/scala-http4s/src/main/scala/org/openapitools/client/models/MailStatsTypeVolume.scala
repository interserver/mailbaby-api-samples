...
case class MailStatsTypeVolume(
    to: Option[Map[String, Int]] = None,
    from: Option[Map[String, Int]] = None,
    ip: Option[Map[String, Int]] = None
)
...
object MailStatsTypeVolume {
  ...
  given decoderMailStatsTypeVolume: Decoder[MailStatsTypeVolume] = Decoder.instance { c =>
    for {
      to <- c.downField("to").as[Option[Map[String, Int]]]
      from <- c.downField("from").as[Option[Map[String, Int]]]
      ip <- c.downField("ip").as[Option[Map[String, Int]]]
