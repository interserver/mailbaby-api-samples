...
export class SendingApi extends BaseAPI {
     ...
     * Sends a raw email
     */
    rawMail({ sendMailRaw }: RawMailRequest): Observable<GenericResponse>
    rawMail({ sendMailRaw }: RawMailRequest, opts?: OperationOpts): Observable<AjaxResponse<GenericResponse>>
    rawMail({ sendMailRaw }: RawMailRequest, opts?: OperationOpts): Observable<GenericResponse | AjaxResponse<GenericResponse>> {
        throwIfNullOrUndefined(sendMailRaw, 'sendMailRaw', 'rawMail');
     ...
     * Sends an Email
     */
    sendMail({ to, from, subject, body, id }: SendMailRequest): Observable<GenericResponse>
    sendMail({ to, from, subject, body, id }: SendMailRequest, opts?: OperationOpts): Observable<AjaxResponse<GenericResponse>>
    sendMail({ to, from, subject, body, id }: SendMailRequest, opts?: OperationOpts): Observable<GenericResponse | AjaxResponse<GenericResponse>> {
