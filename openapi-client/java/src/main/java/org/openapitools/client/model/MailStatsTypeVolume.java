...
public class MailStatsTypeVolume {
  ...
  public MailStatsTypeVolume to(@javax.annotation.Nullable Map<String, Integer> to) {
    this.to = to;
    return this;
  }
  ...
  public MailStatsTypeVolume from(@javax.annotation.Nullable Map<String, Integer> from) {
    this.from = from;
    return this;
  }
  ...
  public MailStatsTypeVolume ip(@javax.annotation.Nullable Map<String, Integer> ip) {
    this.ip = ip;
    return this;
  }
