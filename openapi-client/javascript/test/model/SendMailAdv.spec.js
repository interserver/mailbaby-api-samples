...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailBabyEmailDeliveryAndManagementServiceApi.SendMailAdv();
  });
  ...
  describe('SendMailAdv', function() {
    it('should create an instance of SendMailAdv', function() {
      // uncomment below and update the code to test SendMailAdv
      //var instance = new MailBabyEmailDeliveryAndManagementServiceApi.SendMailAdv();
      //expect(instance).to.be.a(MailBabyEmailDeliveryAndManagementServiceApi.SendMailAdv);
    });
