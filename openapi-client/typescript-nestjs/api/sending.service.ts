...
export class SendingService {
     ...
     * @param {*} [rawMailOpts.config] Override http request option.
     */
    public rawMail(sendMailRaw: SendMailRaw, rawMailOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<GenericResponse>>;
    public rawMail(sendMailRaw: SendMailRaw, rawMailOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        ...
        return accessTokenObservable.pipe(
            switchMap((accessToken) => {
                ...
                return this.httpClient.post<GenericResponse>(`${this.basePath}/mail/rawsend`,
                    sendMailRaw,
                    {
                        withCredentials: this.configuration.withCredentials,
                        ...rawMailOpts?.config,
                        headers: {...headers, ...rawMailOpts?.config?.headers},
                    }
                );
            })
        );
     ...
     */
    public sendMail(to: SendMailTo, _from: string, subject: string, body: string, id?: number, sendMailOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<GenericResponse>>;
    public sendMail(to: SendMailTo, _from: string, subject: string, body: string, id?: number, sendMailOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (to === null || to === undefined) {
