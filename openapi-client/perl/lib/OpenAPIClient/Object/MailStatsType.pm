...
#
package OpenAPIClient::Object::MailStatsType;
...
__PACKAGE__->class_documentation({description => 'Account usage statistics returned by &#x60;GET /mail/stats&#x60;.  Includes billing-cycle usage totals (for cost calculation) as well as time-windowed sent/received counts and volume breakdowns by IP, destination, and source address.',
                                  class => 'MailStatsType',
                                  required => [], # TODO
}                                 );
