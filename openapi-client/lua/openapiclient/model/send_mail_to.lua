...
-- send_mail_to class
local send_mail_to = {}
local send_mail_to_mt = {
	__name = "send_mail_to";
	__index = send_mail_to;
}

local function cast_send_mail_to(t)
	return setmetatable(t, send_mail_to_mt)
end

local function new_send_mail_to()
	return cast_send_mail_to({
	})
end

return {
	cast = cast_send_mail_to;
	new = new_send_mail_to;
}
