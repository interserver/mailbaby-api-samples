...
# Unit tests for SwaggerClient::MailStatsVolume
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MailStatsVolume' do
  before do
    # run before each test
    @instance = SwaggerClient::MailStatsVolume.new
  end
  ...
  describe 'test an instance of MailStatsVolume' do
    it 'should create an instance of MailStatsVolume' do
      expect(@instance).to be_instance_of(SwaggerClient::MailStatsVolume)
    end
  end
