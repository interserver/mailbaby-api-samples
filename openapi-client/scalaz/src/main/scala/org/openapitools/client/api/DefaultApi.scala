...
object DefaultApi {
  ...
  def sendMailById(host: String, id: Long, subject: String, body: String, to: String, from: String)(implicit subjectQuery: QueryParam[String], bodyQuery: QueryParam[String], toQuery: QueryParam[String], fromQuery: QueryParam[String]): Task[GenericResponse] = {
    ...
    val queryParams = Query(
      ("subject", Some(subjectQuery.toParamString(subject))), ("body", Some(bodyQuery.toParamString(body))), ("to", Some(toQuery.toParamString(to))), ("from", Some(fromQuery.toParamString(from))))
...
class HttpServiceDefaultApi(service: HttpService) {
  ...
  def sendMailById(id: Long, subject: String, body: String, to: String, from: String)(implicit subjectQuery: QueryParam[String], bodyQuery: QueryParam[String], toQuery: QueryParam[String], fromQuery: QueryParam[String]): Task[GenericResponse] = {
    implicit val returnTypeDecoder: EntityDecoder[GenericResponse] = jsonOf[GenericResponse]
