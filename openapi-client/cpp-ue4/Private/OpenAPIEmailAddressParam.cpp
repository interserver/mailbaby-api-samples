...
#include "OpenAPIEmailAddressParam.h"
...
void OpenAPIEmailAddressParam::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIEmailAddressParam::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
