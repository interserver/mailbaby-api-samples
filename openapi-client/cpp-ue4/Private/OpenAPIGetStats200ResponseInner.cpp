...
void OpenAPIGetStats200ResponseInner::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGetStats200ResponseInner::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
