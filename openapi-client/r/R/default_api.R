...
#' var.start_date <- 56 # integer | earliest date to get emails in unix timestamp format
#' var.end_date <- 56 # integer | earliest date to get emails in unix timestamp format
#'
...
#' api.instance$api_client$api_keys['X-API-KEY'] <- 'TODO_YOUR_API_KEY';
#'
#' result <- api.instance$ViewMailLog(id=var.id, search=var.search, skip=var.skip, limit=var.limit, start_date=var.start_date, end_date=var.end_date)
#'
#'
#' }
...
DefaultApi <- R6::R6Class(
  ...
  public = list(
    ...
    #' @return MailLog
    #' @export
    ViewMailLog = function(id=NULL, search=NULL, skip=0, limit=100, start_date=NULL, end_date=NULL, data_file = NULL, ...) {
      api_response <- self$ViewMailLogWithHttpInfo(id, search, skip, limit, start_date, end_date, data_file = data_file, ...)
      resp <- api_response$response
      if (httr::status_code(resp) >= 200 && httr::status_code(resp) <= 299) {
        api_response$content
      } else if (httr::status_code(resp) >= 300 && httr::status_code(resp) <= 399) {
    ...
    #' @export
    ViewMailLogWithHttpInfo = function(id=NULL, search=NULL, skip=0, limit=100, start_date=NULL, end_date=NULL, data_file = NULL, ...) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
