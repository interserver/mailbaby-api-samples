...
class ErrorMessage implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ErrorMessage';
    ...
    */
     ...
     * Sets code
     *
     * @param int $code The response code associated with the error.
     *
     * @return $this
     */
     ...
     * Sets message
     *
     * @param string $message The details or description of the error.
     *
     * @return $this
     */
