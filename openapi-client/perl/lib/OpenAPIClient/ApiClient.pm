...
#
package OpenAPIClient::ApiClient;
...
sub new {
    ...
    my $config;
    if ( $_[0] && ref $_[0] && ref $_[0] eq 'OpenAPIClient::Configuration' ) {
        $config = $_[0];
    } else {
        $config = OpenAPIClient::Configuration->new(@_);
    }
...
sub deserialize
{
    ...
    if (not defined $data) {
        ...
        my $_instance = use_module("OpenAPIClient::Object::$class")->new;
        if (ref $data eq "HASH") {
