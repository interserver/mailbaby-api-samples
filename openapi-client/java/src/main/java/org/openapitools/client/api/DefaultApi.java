...
public class DefaultApi {
     ...
     */
    public okhttp3.Call viewMailLogCall(Long id, String search, Integer skip, Integer limit, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call viewMailLogValidateBeforeCall(Long id, String search, Integer skip, Integer limit, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = viewMailLogCall(id, search, skip, limit, _callback);
        return localVarCall;
     ...
     */
    public MailLog viewMailLog(Long id, String search, Integer skip, Integer limit) throws ApiException {
        ApiResponse<MailLog> localVarResp = viewMailLogWithHttpInfo(id, search, skip, limit);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<MailLog> viewMailLogWithHttpInfo(Long id, String search, Integer skip, Integer limit) throws ApiException {
        okhttp3.Call localVarCall = viewMailLogValidateBeforeCall(id, search, skip, limit, null);
     ...
     */
    public okhttp3.Call viewMailLogAsync(Long id, String search, Integer skip, Integer limit, final ApiCallback<MailLog> _callback) throws ApiException {

        okhttp3.Call localVarCall = viewMailLogValidateBeforeCall(id, search, skip, limit, _callback);
        Type localVarReturnType = new TypeToken<MailLog>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
