...
# Unit tests for OpenAPIClient::MailStatsVolume
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe OpenAPIClient::MailStatsVolume do

  describe "test an instance of MailStatsVolume" do
    skip "should create an instance of MailStatsVolume" do
      #instance = OpenAPIClient::MailStatsVolume.new
      #expect(instance).to be_instance_of(OpenAPIClient::MailStatsVolume)
    end
  end
