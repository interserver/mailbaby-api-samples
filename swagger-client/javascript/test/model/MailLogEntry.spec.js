  ...
  describe('(package)', function() {
    describe('MailLogEntry', function() {
      ...
      it('should have the property transhost (base name: "transhost")', function() {
        // TODO: update the code to test the property transhost
        expect(instance).to.have.property('transhost');
        // expect(instance.transhost).to.be(expectedValueLiteral);
      });

      it('should have the property originhost (base name: "originhost")', function() {
        // TODO: update the code to test the property originhost
        expect(instance).to.have.property('originhost');
        // expect(instance.originhost).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property sourceMd5 (base name: "sourceMd5")', function() {
        // TODO: update the code to test the property sourceMd5
        expect(instance).to.have.property('sourceMd5');
        // expect(instance.sourceMd5).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property logger (base name: "logger")', function() {
        // TODO: update the code to test the property logger
        expect(instance).to.have.property('logger');
        // expect(instance.logger).to.be(expectedValueLiteral);
      });

      it('should have the property mxPort (base name: "mxPort")', function() {
        // TODO: update the code to test the property mxPort
        expect(instance).to.have.property('mxPort');
        // expect(instance.mxPort).to.be(expectedValueLiteral);
      });

      it('should have the property connectionKey (base name: "connectionKey")', function() {
        // TODO: update the code to test the property connectionKey
        expect(instance).to.have.property('connectionKey');
        // expect(instance.connectionKey).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property sentBodyHash (base name: "sentBodyHash")', function() {
        // TODO: update the code to test the property sentBodyHash
        expect(instance).to.have.property('sentBodyHash');
        // expect(instance.sentBodyHash).to.be(expectedValueLiteral);
      });

      it('should have the property sentBodySize (base name: "sentBodySize")', function() {
        // TODO: update the code to test the property sentBodySize
        expect(instance).to.have.property('sentBodySize');
        // expect(instance.sentBodySize).to.be(expectedValueLiteral);
      });

      it('should have the property md5Match (base name: "md5Match")', function() {
        // TODO: update the code to test the property md5Match
        expect(instance).to.have.property('md5Match');
        // expect(instance.md5Match).to.be(expectedValueLiteral);
      });
