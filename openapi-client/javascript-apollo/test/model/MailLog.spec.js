...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailBabyEmailDeliveryApi.MailLog();
  });
  ...
  describe('MailLog', function() {
    it('should create an instance of MailLog', function() {
      ...
      //var instance = new MailBabyEmailDeliveryApi.MailLog();
      //expect(instance).to.be.a(MailBabyEmailDeliveryApi.MailLog);
    });
