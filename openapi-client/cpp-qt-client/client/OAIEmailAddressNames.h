...
/*
 * OAIEmailAddressNames.h
 *
 * An array of email contacts, each with an email address and optional display name.
 */

#ifndef OAIEmailAddressNames_H
#define OAIEmailAddressNames_H
...
class OAIEmailAddressNames : public OAIObject {
public:
    OAIEmailAddressNames();
    OAIEmailAddressNames(QString json);
    ~OAIEmailAddressNames() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIEmailAddressNames)

#endif // OAIEmailAddressNames_H
