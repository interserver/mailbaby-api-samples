...
# Unit tests for OpenAPIClient::MailOrderDetail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe OpenAPIClient::MailOrderDetail do

  describe "test an instance of MailOrderDetail" do
    skip "should create an instance of MailOrderDetail" do
      #instance = OpenAPIClient::MailOrderDetail.new
      #expect(instance).to be_instance_of(OpenAPIClient::MailOrderDetail)
    end
  end
