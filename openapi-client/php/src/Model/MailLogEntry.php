...
class MailLogEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('transhost', $data ?? [], null);
        $this->setIfExists('originhost', $data ?? [], null);
        ...
        $this->setIfExists('sourceMd5', $data ?? [], null);
        ...
        $this->setIfExists('logger', $data ?? [], null);
        $this->setIfExists('mxPort', $data ?? [], null);
        $this->setIfExists('connectionKey', $data ?? [], null);
        $this->setIfExists('mxHostname', $data ?? [], null);
        $this->setIfExists('sentBodyHash', $data ?? [], null);
        $this->setIfExists('sentBodySize', $data ?? [], null);
        $this->setIfExists('md5Match', $data ?? [], null);
    }
    ...
    */
    ...
    public function setTranshost($transhost)
    {
        ...
        if (is_null($transhost)) {
            throw new \InvalidArgumentException('non-nullable transhost cannot be null');
        }
    ...
    public function setOriginhost($originhost)
    {
        ...
        if (is_null($originhost)) {
            throw new \InvalidArgumentException('non-nullable originhost cannot be null');
        }
    ...
    public function setSourceMd5($sourceMd5)
    {
        ...
        if (is_null($sourceMd5)) {
            throw new \InvalidArgumentException('non-nullable sourceMd5 cannot be null');
        }
    ...
    public function setLogger($logger)
    {
        ...
        if (is_null($logger)) {
            throw new \InvalidArgumentException('non-nullable logger cannot be null');
        }
    ...
    public function setMxPort($mxPort)
    {
        ...
        if (is_null($mxPort)) {
            throw new \InvalidArgumentException('non-nullable mxPort cannot be null');
        }
    ...
    public function setConnectionKey($connectionKey)
    {
        ...
        if (is_null($connectionKey)) {
            throw new \InvalidArgumentException('non-nullable connectionKey cannot be null');
        }
    ...
    public function setSentBodyHash($sentBodyHash)
    {
        ...
        if (is_null($sentBodyHash)) {
            throw new \InvalidArgumentException('non-nullable sentBodyHash cannot be null');
        }
    ...
    public function setSentBodySize($sentBodySize)
    {
        ...
        if (is_null($sentBodySize)) {
            throw new \InvalidArgumentException('non-nullable sentBodySize cannot be null');
        }
    ...
    public function setMd5Match($md5Match)
    {
        ...
        if (is_null($md5Match)) {
            throw new \InvalidArgumentException('non-nullable md5Match cannot be null');
        }
