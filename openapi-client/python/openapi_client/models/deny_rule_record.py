...
class DenyRuleRecord(BaseModel):
    ...
    id: StrictInt = Field(..., description="The deny rule Id number.")
    created: datetime = Field(..., description="the date the rule was created.")
    __properties = ["user", "type", "data", "id", "created"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DenyRuleRecord:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DenyRuleRecord:
        """Create an instance of DenyRuleRecord from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DenyRuleRecord.parse_obj(obj)

        _obj = DenyRuleRecord.parse_obj({
            "user": obj.get("user"),
            "type": obj.get("type"),
            "data": obj.get("data"),
            "id": obj.get("id"),
