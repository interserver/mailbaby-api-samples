...
open class DefaultAPI: APIBase {
  ...
  "username" : "mb1234"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func sendMailById(id: Int64, subject: String? = nil, body: String? = nil, to: String? = nil, from: String? = nil, completion: @escaping ((_ data: GenericResponse?, _ error: ErrorResponse?) -> Void)) {
        sendMailByIdWithRequestBuilder(id: id, subject: subject, body: body, to: to, from: from).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
