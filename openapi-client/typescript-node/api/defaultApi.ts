...
let defaultBasePath = 'http://mystage.interserver.net:8787';
...
export class DefaultApi {
     ...
     */
    public async viewMailLog (id?: number, searchString?: string, skip?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<MailLog>;  }> {
