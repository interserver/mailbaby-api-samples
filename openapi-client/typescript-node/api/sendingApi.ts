...
export class SendingApi {
     ...
     */
    public async sendMail (to: string, from: string, subject: string, body: string, id?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GenericResponse;  }> {
