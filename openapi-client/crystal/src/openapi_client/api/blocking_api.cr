  ...
  class BlockingApi
    ...
    def add_rule_with_http_info(_type : String, data : String, user : String? = nil)
      ...
      data, status_code, headers = @api_client.call_api(
        http_method: :POST,
        path: local_var_path,
        operation: :"BlockingApi.add_rule",
        post_body: post_body,
    ...
    # @param rule_id [Int32] The numeric ID of the deny rule to delete.  Obtain this from the &#x60;id&#x60; field in &#x60;GET /mail/rules&#x60; or the &#x60;text&#x60; field of a &#x60;POST /mail/rules&#x60; response.
    # @return [GenericResponse]
    ...
    def delete_rule_with_http_info(rule_id : Int32)
      ...
      data, status_code, headers = @api_client.call_api(
        http_method: :DELETE,
        path: local_var_path,
        operation: :"BlockingApi.delete_rule",
        post_body: post_body,
        auth_names: auth_names,
        header_params: header_params,
        query_params: query_params,
    ...
    # @param email_address_param [EmailAddressParam] 
    # @return [GenericResponse]
    def delist_block(email_address_param : EmailAddressParam)
      data, _status_code, _headers = delist_block_with_http_info(email_address_param)
      data
    end
    ...
    # @param email_address_param [EmailAddressParam] 
    # @return [Array<(GenericResponse, Integer, Hash)>] GenericResponse data, response status code and response headers
    def delist_block_with_http_info(email_address_param : EmailAddressParam)
      if @api_client.config.debugging
        Log.debug {"Calling API: BlockingApi.delist_block ..."}
      end
      # verify the required parameter "email_address_param" is set
      if @api_client.config.client_side_validation && email_address_param.nil?
        raise ArgumentError.new("Missing the required parameter 'email_address_param' when calling BlockingApi.delist_block")
      end
      # resource path
      ...
      # http body (model)
      post_body = email_address_param.to_json
      ...
      data, status_code, headers = @api_client.call_api(
        http_method: :POST,
        path: local_var_path,
        operation: :"BlockingApi.delist_block",
        post_body: post_body,
        auth_names: auth_names,
        header_params: header_params,
        query_params: query_params,
    ...
    def get_mail_blocks_with_http_info()
      ...
      data, status_code, headers = @api_client.call_api(
        http_method: :GET,
        path: local_var_path,
        operation: :"BlockingApi.get_mail_blocks",
        post_body: post_body,
        auth_names: auth_names,
        header_params: header_params,
        query_params: query_params,
    ...
    def get_rules_with_http_info()
      ...
      data, status_code, headers = @api_client.call_api(
        http_method: :GET,
        path: local_var_path,
        operation: :"BlockingApi.get_rules",
        post_body: post_body,
        auth_names: auth_names,
        header_params: header_params,
        query_params: query_params,
