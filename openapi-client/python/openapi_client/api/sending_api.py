...
class SendingApi:
    ...
    def send_adv_mail(
        ...
        **kwargs,
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the send_adv_mail_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        return self.send_adv_mail_with_http_info.raw_function(
            subject,
            body,
            var_from,
            to,
    ...
    def send_adv_mail_with_http_info(
        ...
        **kwargs,
        ...
        _files: Dict[str, str] = {}
        if _params['subject'] is not None:
    ...
    def send_mail(
        ...
        **kwargs,
        ...
        return self.send_mail_with_http_info.raw_function(
            to,
            var_from,
            subject,
            body,
