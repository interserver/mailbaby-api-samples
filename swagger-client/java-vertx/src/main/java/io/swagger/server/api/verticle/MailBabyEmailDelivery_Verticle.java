...
public class MailBabyEmailDelivery_Verticle extends AbstractVerticle {
    static final Logger LOGGER = LoggerFactory.getLogger(MailBabyEmailDelivery_Verticle.class);
    ...
    public void start(Promise<Void> startPromise) throws Exception {
      ...
      return server.listen()
          .onSuccess(server -> LOGGER.info("MailBabyEmailDelivery_Verticle started on port " + server.actualPort()));
      })
