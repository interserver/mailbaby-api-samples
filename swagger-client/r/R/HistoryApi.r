...
#' @description mailbaby-client-r.History
#'
...
HistoryApi <- R6::R6Class(
  ...
  public = list(
    ...
    view_mail_log = function(id, origin, mx, from, to, subject, mailid, message_id, replyto, headerfrom, delivered, skip, limit, start_date, end_date, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
