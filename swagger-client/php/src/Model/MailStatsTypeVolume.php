...
class MailStatsTypeVolume implements ModelInterface, ArrayAccess
{
     ...
     * Sets to
     *
     * @param map[string,int] $to Message counts keyed by destination (envelope `to`) email address.
     *
     * @return $this
     */
     ...
     * Sets from
     *
     * @param map[string,int] $from Message counts keyed by sender (envelope `from`) email address.
     *
     * @return $this
     */
     ...
     * Sets ip
     *
     * @param map[string,int] $ip Message counts keyed by originating client IP address.
     *
     * @return $this
     */
