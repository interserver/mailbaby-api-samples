...
Describe -tag 'PSOpenAPITools' -name 'MailStatsVolume' {
    Context 'MailStatsVolume' {
        It 'Initialize-MailStatsVolume' {
            # a simple test to create an object
            #$NewObject = Initialize-MailStatsVolume -To "TEST_VALUE" -VarFrom "TEST_VALUE" -Ip "TEST_VALUE"
            #$NewObject | Should -BeOfType MailStatsVolume
