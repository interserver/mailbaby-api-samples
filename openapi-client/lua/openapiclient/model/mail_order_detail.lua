...
-- mail_order_detail class
local mail_order_detail = {}
local mail_order_detail_mt = {
	__name = "mail_order_detail";
	__index = mail_order_detail;
}

local function cast_mail_order_detail(t)
	return setmetatable(t, mail_order_detail_mt)
end

local function new_mail_order_detail(id, status, username, comment, password)
	return cast_mail_order_detail({
		["id"] = id;
		["status"] = status;
		["username"] = username;
		["comment"] = comment;
...
return {
	cast = cast_mail_order_detail;
	new = new_mail_order_detail;
}
