...
OAISendMail_to::OAISendMail_to(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISendMail_to::OAISendMail_to() {
    this->initializeModel();
}

OAISendMail_to::~OAISendMail_to() {}

void OAISendMail_to::initializeModel() {

}

void OAISendMail_to::fromJson(QString jsonString) {
...
void OAISendMail_to::fromJsonObject(QJsonObject json) {

}

QString OAISendMail_to::asJson() const {
...
QJsonObject OAISendMail_to::asJsonObject() const {
    QJsonObject obj;
    return obj;
}

bool OAISendMail_to::isSet() const {
...
bool OAISendMail_to::isValid() const {
