...
# **sendMail**
```swift
    open class func sendMail(to: String, from: String, subject: String, body: String, id: Int? = nil, completion: @escaping (_ data: GenericResponse?, _ error: Error?) -> Void)
```
...
let subject = "subject_example" // String | The subject or title of the email
let body = "body_example" // String | The main email contents.
let id = 987 // Int | Optional Order ID (optional)
