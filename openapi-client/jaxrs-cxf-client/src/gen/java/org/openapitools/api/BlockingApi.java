...
public interface BlockingApi  {
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Rule created successfully", response = GenericResponse.class),
    ...
    @Path("/rules/{ruleId}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Removes a deny mail rule", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Rule deleted successfully", response = GenericResponse.class),
        @ApiResponse(code = 400, message = "Bad request — one or more input parameters were missing or invalid.", response = ErrorMessage.class),
        @ApiResponse(code = 401, message = "Authentication failed.  Ensure you are sending a valid `X-API-KEY` header. Obtain your API key from [my.interserver.net/account_security](https://my.interserver.net/account_security).", response = ErrorMessage.class),
        @ApiResponse(code = 404, message = "The specified resource was not found or does not belong to your account.", response = ErrorMessage.class) })
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Removes an email address from the block lists", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Address successfully delisted", response = GenericResponse.class),
        @ApiResponse(code = 400, message = "Bad request — one or more input parameters were missing or invalid.", response = ErrorMessage.class),
        @ApiResponse(code = 401, message = "Authentication failed.  Ensure you are sending a valid `X-API-KEY` header. Obtain your API key from [my.interserver.net/account_security](https://my.interserver.net/account_security).", response = ErrorMessage.class),
        @ApiResponse(code = 404, message = "The specified resource was not found or does not belong to your account.", response = ErrorMessage.class) })
    public GenericResponse delistBlock(EmailAddressParam emailAddressParam);
