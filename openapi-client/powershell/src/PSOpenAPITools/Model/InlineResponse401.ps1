...
InlineResponse401<PSCustomObject>
#>

function Initialize-InlineResponse401 {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InlineResponse401' | Write-Debug
...
Convert from JSON to InlineResponse401<PSCustomObject>
...
InlineResponse401<PSCustomObject>
#>
function ConvertFrom-JsonToInlineResponse401 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InlineResponse401' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InlineResponse401
