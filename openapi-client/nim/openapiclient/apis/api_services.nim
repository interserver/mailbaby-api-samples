...
import ../models/model_mail_order_detail
...
proc getMailOrderById*(httpClient: HttpClient, id: int64): (Option[MailOrderDetail], Response) =
  ## Displays details for a single mail order

  let response = httpClient.get(basepath & fmt"/mail/{id}")
  constructResult[MailOrderDetail](response)
