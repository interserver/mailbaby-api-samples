...
*BlockingAPI* | [**BlockingAPI_deleteRule**](docs/BlockingAPI.md#BlockingAPI_deleteRule) | **DELETE** /mail/rules/{ruleId} | Removes a deny mail rule
*BlockingAPI* | [**BlockingAPI_delistBlock**](docs/BlockingAPI.md#BlockingAPI_delistBlock) | **POST** /mail/blocks/delete | Removes an email address from the block lists
...
*SendingAPI* | [**SendingAPI_rawMail**](docs/SendingAPI.md#SendingAPI_rawMail) | **POST** /mail/rawsend | Sends a raw RFC 822 email
...
*ServicesAPI* | [**ServicesAPI_getMailOrderById**](docs/ServicesAPI.md#ServicesAPI_getMailOrderById) | **GET** /mail/{id} | Displays details for a single mail order
...
## Documentation for Models
 ...
 - [email_address_names_t](docs/email_address_names.md)
 - [email_address_param_t](docs/email_address_param.md)
