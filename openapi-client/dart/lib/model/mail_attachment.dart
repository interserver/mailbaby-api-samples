...
class MailAttachment {
  ...
  static MailAttachment? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<MailAttachment> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <MailAttachment>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MailAttachment.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MailAttachment> mapFromJson(dynamic json) {
    final map = <String, MailAttachment>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MailAttachment.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<MailAttachment>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<MailAttachment>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = MailAttachment.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
