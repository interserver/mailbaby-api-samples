...
feature -- API Access
	...
	add_rule (type: STRING_32; data: STRING_32; user: STRING_32): detachable GENERIC_RESPONSE
			...
			-- 
			-- argument: data The value to match against, interpreted according to &#x60;type&#x60;: a full email address for &#x60;email&#x60;/&#x60;destination&#x60;, a domain name for &#x60;domain&#x60;, or an alphanumeric prefix string for &#x60;startswith&#x60;. (required)
			-- 
			-- argument: user Optional SMTP username of the mail order to associate this rule with (e.g. &#x60;mb20682&#x60;).  If omitted the first active order is used.  Valid usernames are the &#x60;username&#x60; values returned by &#x60;GET /mail&#x60;. (optional, default to null)
			-- 
			-- 
	...
	delete_rule (rule_id: INTEGER_32): detachable GENERIC_RESPONSE
			...
			-- 
			-- argument: rule_id The numeric ID of the deny rule to delete.  Obtain this from the &#x60;id&#x60; field in &#x60;GET /mail/rules&#x60; or the &#x60;text&#x60; field of a &#x60;POST /mail/rules&#x60; response. (required)
			-- 
			-- 
			-- Result GENERIC_RESPONSE
		require
	...
	delist_block (email_address_param: EMAIL_ADDRESS_PARAM): detachable GENERIC_RESPONSE
			...
			-- 
			-- argument: email_address_param  (required)
			-- 
			-- 
			-- Result GENERIC_RESPONSE
		require
		...
		do
			reset_error
			create l_request
			l_request.set_body(email_address_param)
