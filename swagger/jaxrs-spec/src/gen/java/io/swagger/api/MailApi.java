...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJAXRSSpecServerCodegen", date = "2021-04-21T00:13:49.688562-04:00[America/New_York]")
...
@SecurityRequirement(name = "apiPasswordAuth")    }, tags={  })
    ...
    public Response sendAdvMailById(@Valid SendMail body, @PathParam("id")
...
@SecurityRequirement(name = "apiPasswordAuth")    }, tags={  })
    ...
    public Response sendAdvMailById(@FormParam(value = "id")  Long id2, @PathParam("id")
