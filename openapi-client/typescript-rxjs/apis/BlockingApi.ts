...
export class BlockingApi extends BaseAPI {
     ...
     */
    delistBlock({ emailAddressParam }: DelistBlockRequest): Observable<GenericResponse>
    delistBlock({ emailAddressParam }: DelistBlockRequest, opts?: OperationOpts): Observable<AjaxResponse<GenericResponse>>
    delistBlock({ emailAddressParam }: DelistBlockRequest, opts?: OperationOpts): Observable<GenericResponse | AjaxResponse<GenericResponse>> {
        throwIfNullOrUndefined(emailAddressParam, 'emailAddressParam', 'delistBlock');
