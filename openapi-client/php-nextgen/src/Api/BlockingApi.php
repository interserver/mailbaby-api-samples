...
class BlockingApi
{
     ...
     *
     * @param  \OpenAPI\Client\Model\EmailAddressParam $email_address_param email_address_param (required)
    ...
    public function delistBlock(
        \OpenAPI\Client\Model\EmailAddressParam $email_address_param,
        string $contentType = self::contentTypes['delistBlock'][0]
    ): \OpenAPI\Client\Model\GenericResponse|\OpenAPI\Client\Model\ErrorMessage
    {
        list($response) = $this->delistBlockWithHttpInfo($email_address_param, $contentType);
        return $response;
    }
     ...
     * Removes an email address from the block lists
     *
     * @param  \OpenAPI\Client\Model\EmailAddressParam $email_address_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['delistBlock'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
    ...
    {
        $request = $this->delistBlockRequest($email_address_param, $contentType);
    ...
    {
        return $this->delistBlockAsyncWithHttpInfo($email_address_param, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    ): Request
    {
        ...
        // verify the required parameter 'email_address_param' is set
        if ($email_address_param === null || (is_array($email_address_param) && count($email_address_param) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $email_address_param when calling delistBlock'
            );
        }
        ...
        // for model (json/xml)
        if (isset($email_address_param)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($email_address_param));
            } else {
                $httpBody = $email_address_param;
            }
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\MailBlocks|\OpenAPI\Client\Model\ErrorMessage, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\DenyRuleRecord[]|\OpenAPI\Client\Model\ErrorMessage, HTTP status code, HTTP response headers (array of strings)
     */
