...
export function SendMailAdvBccInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): SendMailAdvBccInner {
...
export function SendMailAdvBccInnerToJSON(value?: SendMailAdvBccInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
