...
public class HistoryApiServiceImpl implements HistoryApi {
     ...
     *
     */
    public MailLog viewMailLog(Long id, String origin, String mx, String from, String to, String subject, String mailid, String messageId, String replyto, String headerfrom, Integer delivered, Integer skip, Integer limit, Long startDate, Long endDate) {
        // TODO: Implement...
