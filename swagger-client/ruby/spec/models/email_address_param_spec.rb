...
# Unit tests for SwaggerClient::EmailAddressParam
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EmailAddressParam' do
  before do
    # run before each test
    @instance = SwaggerClient::EmailAddressParam.new
  end
  ...
  describe 'test an instance of EmailAddressParam' do
    it 'should create an instance of EmailAddressParam' do
      expect(@instance).to be_instance_of(SwaggerClient::EmailAddressParam)
    end
  end
