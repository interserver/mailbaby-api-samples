...
class SendMailAdv implements ModelInterface, ArrayAccess
{
     ...
     * Sets replyto
     *
     * @param \Interserver\Mailbaby\Model\EmailAddressName[] $replyto (optional) A list of email addresses that specify where replies to the email should be sent instead of the _from_ address.
     *
     * @return $this
     */
     ...
     * Sets cc
     *
     * @param \Interserver\Mailbaby\Model\EmailAddressName[] $cc (optional) A list of email addresses to carbon copy this message to.  They are listed on the email and anyone getting the email can see this full list of Contacts who received the email as well.
     *
     * @return $this
     */
     ...
     * Sets bcc
     *
     * @param \Interserver\Mailbaby\Model\EmailAddressName[] $bcc (optional) list of email addresses that should receive copies of the email.  They are hidden on the email and anyone gettitng the email would not see the other people getting the email in this list.
     *
     * @return $this
     */
