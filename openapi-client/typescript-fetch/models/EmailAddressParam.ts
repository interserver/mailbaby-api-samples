...
/**
 * Check if a given object implements the EmailAddressParam interface.
 */
export function instanceOfEmailAddressParam(value: object): value is EmailAddressParam {
    if (!('email' in value) || value['email'] === undefined) return false;
    return true;
}

export function EmailAddressParamFromJSON(json: any): EmailAddressParam {
    return EmailAddressParamFromJSONTyped(json, false);
}

export function EmailAddressParamFromJSONTyped(json: any, ignoreDiscriminator: boolean): EmailAddressParam {
    if (json == null) {
        return json;
    }
    return {
...
export function EmailAddressParamToJSON(json: any): EmailAddressParam {
    return EmailAddressParamToJSONTyped(json, false);
}

export function EmailAddressParamToJSONTyped(value?: EmailAddressParam | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
