  ...
  public = list(
    ...
    initialize = function(instance = NULL) {
      if (is.null(instance)) {
        ...
        stop(paste("Failed to initialize SendMailTo with oneOf schemas array[character], character. Provided class name: ",
                   get(class(instance)[[1]], pos = -1)$classname))
      }
    },

    #' @description
    #' Deserialize JSON string into an instance of SendMailTo.
    #' An alias to the method `fromJSON` .
    #'
    #' @param input The input JSON.
    #'
    #' @return An instance of SendMailTo.
    ...
    fromJSON = function(input) {
      ...
      if (matched == 1) {
        ...
        # more than 1 match
        stop(paste("Multiple matches found when deserializing the input into SendMailTo with oneOf schemas array[character], character. Matched schemas: ",
                   paste(matched_schemas, collapse = ", ")))
      } else {
        # no match
        stop(paste("No match found when deserializing the input into SendMailTo with oneOf schemas array[character], character. Details: >>",
    ...
    #' @description
    #' Serialize SendMailTo to JSON string.
    #' 
    #' @param ... Parameters passed to `jsonlite::toJSON`
    #' @return JSON string representation of the SendMailTo.
    ...
    #' @description
    #' Convert SendMailTo to a base R type
    #'
    ...
    #' @description
    #' Validate the input JSON with respect to SendMailTo and
...
#SendMailTo$set("public", "print", function(...) {
#  print(jsonlite::prettify(self$toJSONString()))
#  invisible(self)
#})
