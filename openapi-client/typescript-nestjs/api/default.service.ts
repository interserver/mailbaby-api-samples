...
export class DefaultService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public viewMailLog(id?: number, search?: string, skip?: number, limit?: number, ): Observable<AxiosResponse<MailLog>>;
    public viewMailLog(id?: number, search?: string, skip?: number, limit?: number, ): Observable<any> {
