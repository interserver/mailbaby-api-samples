...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailBabyEmailDeliveryAndManagementServiceApi.ServicesApi();
  });

  describe('(package)', function() {
    describe('ServicesApi', function() {
      describe('getMailOrderById', function() {
        it('should call getMailOrderById successfully', function(done) {
          // TODO: uncomment, update parameter values for getMailOrderById call and complete the assertions
          /*

          instance.getMailOrderById(id, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(MailBabyEmailDeliveryAndManagementServiceApi.MailOrderDetail);
        ...
        it('should call getMailOrders successfully', function(done) {
          ...
          instance.getMailOrders(function(error, data, response) {
            ...
            for (let p in dataCtr) {
              let data = dataCtr[p];
              expect(data).to.be.a(MailBabyEmailDeliveryAndManagementServiceApi.MailOrder);
            }
