...
public class MailLogEntry {
    ...
    public MailLogEntry(Integer id, String id, String from, String to, String subject, String created, Integer time, String user, String transtype, String origin, String _interface, String sendingZone, Integer bodySize, Integer seq, String recipient, String domain, Integer locked, String lockTime, String assigned, String queued, String mxHostname, String response) {
        this.id = id;
        this.id = id;
        this.from = from;
        this.to = to;
