...
class HistoryApi(object):
    ...
    def view_mail_log(self, **kwargs):  # noqa: E501
        ...
        :param str delivered: Limiting the emails to wether or not they were delivered.
        :return: MailLog
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def view_mail_log_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'origin', 'mx', '_from', 'to', 'subject', 'mailid', 'skip', 'limit', 'start_date', 'end_date', 'replyto', 'headerfrom', 'delivered']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
