...
class EmailAddressParam(object):
    ...
    def __init__(self, email=None):  # noqa: E501
        """EmailAddressParam - a model defined in Swagger"""  # noqa: E501
        self._email = None
    ...
    @property
    def email(self):
        """Gets the email of this EmailAddressParam.  # noqa: E501

        The email address to delist from all block lists.  # noqa: E501

        :return: The email of this EmailAddressParam.  # noqa: E501
        :rtype: str
        """
        return self._email
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EmailAddressParam, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EmailAddressParam):
            return False
