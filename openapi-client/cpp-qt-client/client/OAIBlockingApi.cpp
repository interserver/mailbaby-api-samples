...
void OAIBlockingApi::setServerIndex(int serverIndex) {
...
void OAIBlockingApi::delistBlock(const OAIEmailAddressParam &oai_email_address_param) {
...

    {
        ...
        QByteArray output = oai_email_address_param.asJson().toUtf8();
