...
namespace mailbaby-client-aspnetcore.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class MailStatsVolume : IEquatable<MailStatsVolume>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((MailStatsVolume)obj);
        }

        /// <summary>
        /// Returns true if MailStatsVolume instances are equal
        /// </summary>
        /// <param name="other">Instance of MailStatsVolume to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MailStatsVolume other)
        {
        ...
        public static bool operator ==(MailStatsVolume left, MailStatsVolume right)
        {
