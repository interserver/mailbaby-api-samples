...
__PACKAGE__->class_documentation({description => 'The primary recipient address.  Accepts a single email address string or an array of email address strings for multiple recipients.',
                                  class => 'SendMailTo',
                                  required => [], # TODO
}                                 );
