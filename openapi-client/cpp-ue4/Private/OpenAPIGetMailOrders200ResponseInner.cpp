...
void OpenAPIGetMailOrders200ResponseInner::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGetMailOrders200ResponseInner::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
