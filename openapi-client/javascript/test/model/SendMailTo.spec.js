...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailBabyEmailDeliveryAndManagementServiceApi.SendMailTo();
  });
  ...
  describe('SendMailTo', function() {
    it('should create an instance of SendMailTo', function() {
      // uncomment below and update the code to test SendMailTo
      //var instance = new MailBabyEmailDeliveryAndManagementServiceApi.SendMailTo();
      //expect(instance).to.be.a(MailBabyEmailDeliveryAndManagementServiceApi.SendMailTo);
    });
