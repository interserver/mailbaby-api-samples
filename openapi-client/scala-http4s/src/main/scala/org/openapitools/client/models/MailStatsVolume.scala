...
object MailStatsVolume {
  given encoderMailStatsVolume: Encoder[MailStatsVolume] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderMailStatsVolume: Decoder[MailStatsVolume] = Decoder.instance { c =>
    for {
