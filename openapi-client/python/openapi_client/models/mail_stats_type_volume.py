...
class MailStatsTypeVolume(BaseModel):
    ...
    """ # noqa: E501
    to: Optional[Dict[str, StrictInt]] = Field(default=None, description="Message counts keyed by destination (envelope `to`) email address.")
    var_from: Optional[Dict[str, StrictInt]] = Field(default=None, description="Message counts keyed by sender (envelope `from`) email address.", alias="from")
    ip: Optional[Dict[str, StrictInt]] = Field(default=None, description="Message counts keyed by originating client IP address.")
