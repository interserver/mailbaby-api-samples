...
class DefaultApi(
   ...
   */
  def sendMailById(id: Long, subject: Option[String] = None, body: Option[String] = None, to: Option[String] = None, from: Option[String] = None): Option[GenericResponse] = {
    val await = Try(Await.result(sendMailByIdAsync(id, subject, body, to, from), Duration.Inf))
    await match {
      case Success(i) => Some(await.get)
      case Failure(t) => None
    }
   ...
   */
  def sendMailByIdAsync(id: Long, subject: Option[String] = None, body: Option[String] = None, to: Option[String] = None, from: Option[String] = None): Future[GenericResponse] = {
      helper.sendMailById(id, subject, body, to, from)
  }
