...
# Unit tests for SwaggerClient::SendMailTo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SendMailTo' do
  before do
    # run before each test
    @instance = SwaggerClient::SendMailTo.new
  end
  ...
  describe 'test an instance of SendMailTo' do
    it 'should create an instance of SendMailTo' do
      expect(@instance).to be_instance_of(SwaggerClient::SendMailTo)
    end
  end
end
