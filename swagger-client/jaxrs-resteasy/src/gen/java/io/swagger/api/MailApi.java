...
,@Context SecurityContext securityContext)
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "404", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorMessage.class))) })
    public Response getStats(  @QueryParam("time") String time,@Context SecurityContext securityContext)
    throws NotFoundException {
...
,@Context SecurityContext securityContext)
    ...
    public Response viewMailLog(  @QueryParam("id") Long id,  @QueryParam("origin") String origin,  @QueryParam("mx") String mx,  @QueryParam("from") String from,  @QueryParam("to") String to,  @QueryParam("subject") String subject,  @QueryParam("mailid") String mailid, @Min(0)  @DefaultValue("0") @QueryParam("skip") Integer skip, @Min(1) @Max(10000)  @DefaultValue("100") @QueryParam("limit") Integer limit, @Min(0L) @Max(9999999999L)  @QueryParam("startDate") Long startDate, @Min(0L) @Max(9999999999L)  @QueryParam("endDate") Long endDate,  @QueryParam("replyto") String replyto,  @QueryParam("headerfrom") String headerfrom,  @QueryParam("delivered") String delivered,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.viewMailLog(id,origin,mx,from,to,subject,mailid,skip,limit,startDate,endDate,replyto,headerfrom,delivered,securityContext);
    }
}
