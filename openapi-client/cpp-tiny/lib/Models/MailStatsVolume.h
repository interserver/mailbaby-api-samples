...
#ifndef TINY_CPP_CLIENT_MailStatsVolume_H_
#define TINY_CPP_CLIENT_MailStatsVolume_H_
...
/*! \brief Top-500 breakdown of message counts within the selected time window, grouped by originating IP, destination address, and sender address.
 *
 *  \ingroup Models
 *
 */
...
public:
	 ...
	 */
    MailStatsVolume();
    MailStatsVolume(std::string jsonString);


    /*! \brief Destructor.
	 */
    virtual ~MailStatsVolume();
...
#endif /* TINY_CPP_CLIENT_MailStatsVolume_H_ */
