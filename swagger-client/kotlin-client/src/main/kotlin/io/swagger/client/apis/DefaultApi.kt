...
class DefaultApi(basePath: kotlin.String = "https://api.mailbaby.net/") : ApiClient(basePath) {
     ...
     */
    @Suppress("UNCHECKED_CAST")
    fun sendMailById(id: kotlin.Long, subject: kotlin.String? = null, body: kotlin.String? = null, to: kotlin.String? = null, from: kotlin.String? = null): GenericResponse {
        val localVariableQuery: MultiValueMap = mapOf("subject" to listOf("$subject"), "body" to listOf("$body"), "to" to listOf("$to"), "from" to listOf("$from"))
        val localVariableConfig = RequestConfig(
                RequestMethod.POST,
