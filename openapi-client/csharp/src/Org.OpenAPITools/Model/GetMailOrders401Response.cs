...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class GetMailOrders401Response :  IEquatable<GetMailOrders401Response>, IValidatableObject
    {
        ...
        public GetMailOrders401Response(string code = default(string), string message = default(string))
        {
            ...
            if (code == null)
            {
                throw new InvalidDataException("code is a required property for GetMailOrders401Response and cannot be null");
            }
            else
            {
                this.Code = code;
            ...
            if (message == null)
            {
                throw new InvalidDataException("message is a required property for GetMailOrders401Response and cannot be null");
            }
            else
            {
