...
class DefaultApi(baseUrl: String) {
   ...
   */
  def viewMailLog(apiKey: String)(id: Option[Long] = None, search: Option[String] = None, skip: Option[Int] = None, limit: Option[Int] = None, startDate: Option[Long] = None, endDate: Option[Long] = None
): Request[Either[ResponseException[String, Exception], MailLog], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/mail/log?id=${ id }&search=${ search }&skip=${ skip }&limit=${ limit }&startDate=${ startDate }&endDate=${ endDate }")
      .contentType("application/json")
      .header("X-API-KEY", apiKey)
