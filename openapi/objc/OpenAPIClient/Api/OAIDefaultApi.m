...
-(NSURLSessionTask*) getMailByIdWithId: (NSNumber*) _id
    ...
    NSArray *authSettings = @[@"apiKeyAuth", @"apiLoginAuth", @"apiPasswordAuth"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"OAIMailOrder*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIMailOrder*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getMailOrdersWithCompletionHandler: 
    ...
    [headerParams addEntriesFromDictionary:self.defaultHeaders];
    // HTTP header `Accept`
    NSString *acceptHeader = [self.apiClient.sanitizer selectHeaderAccept:@[@"application/json", @"application/xml", @"text/plain"]];
    if(acceptHeader.length > 0) {
        headerParams[@"Accept"] = acceptHeader;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<OAIMailOrder>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<OAIMailOrder>*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) sendAdvMailByIdWithId: (NSNumber*) _id
    ...
    // request content type
    NSString *requestContentType = [self.apiClient.sanitizer selectHeaderContentType:@[@"application/json", @"application/xml", @"application/x-www-form-urlencoded", @"text/plain"]];
...
-(NSURLSessionTask*) viewMailLogByIdWithId: (NSNumber*) _id
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<OAIMailLog>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<OAIMailLog>*)data, error);
                                }
                            }];
}
