...
feature -- API Access
	...
	send_adv_mail (subject: STRING_32; body: STRING_32; var_from: EMAIL_ADDRESS_TYPES; to: EMAIL_ADDRESSES_TYPES; replyto: detachable EMAIL_ADDRESSES_TYPES; cc: detachable EMAIL_ADDRESSES_TYPES; bcc: detachable EMAIL_ADDRESSES_TYPES; attachments: detachable LIST [MAIL_ATTACHMENT]; id: INTEGER_64): detachable GENERIC_RESPONSE
			...
			-- 
			-- argument: subject The subject line of the email. (required)
			-- 
			-- argument: body The email body.  If the string contains any HTML tags the message is automatically sent as &#x60;text/html&#x60;; otherwise it is sent as &#x60;text/plain&#x60;. (required)
			-- 
			...
			-- 
			-- argument: attachments Optional list of file attachments.  Each file must be base64-encoded. Include &#x60;filename&#x60; so recipients see a meaningful attachment name. (optional, default to null)
			-- 
			-- argument: id Optional numeric ID of the mail order to send through.  If omitted the first active order on your account is used automatically.  Valid IDs are returned by &#x60;GET /mail&#x60;. (optional, default to null)
			-- 
			-- 
			-- Result GENERIC_RESPONSE
		require
	...
	send_mail (to: SEND_MAIL_TO; var_from: STRING_32; subject: STRING_32; body: STRING_32; id: INTEGER_64): detachable GENERIC_RESPONSE
			-- Sends an Email
			...
			-- argument: to  (required)
			-- 
			-- argument: var_from The sender address.  This is used as both the &#x60;From&#x60; header and the &#x60;Reply-To&#x60; header automatically.  Must be a valid email address authorized for your mail order. (required)
			-- 
			-- argument: subject The subject line of the email. (required)
			-- 
			-- argument: body The email body.  If the string contains any HTML tags the message is automatically sent as &#x60;text/html&#x60;; otherwise it is sent as &#x60;text/plain&#x60;. (required)
