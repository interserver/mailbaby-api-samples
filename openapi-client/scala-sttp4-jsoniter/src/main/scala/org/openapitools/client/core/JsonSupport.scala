...
object JsonSupport extends AdditionalTypeSerializers:
  ...
  given mailOrderDetailCodec: JsonValueCodec[MailOrderDetail] = deriveJsonCodec
  given emailAddressParamCodec: JsonValueCodec[EmailAddressParam] = deriveJsonCodec
