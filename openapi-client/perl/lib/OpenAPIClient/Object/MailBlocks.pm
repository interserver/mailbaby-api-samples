...
#
package OpenAPIClient::Object::MailBlocks;
...
__PACKAGE__->class_documentation({description => 'The complete set of blocked addresses and message patterns returned by &#x60;GET /mail/blocks&#x60;.  Three independent block sources are combined into one response. Use &#x60;POST /mail/blocks/delete&#x60; with a &#x60;from&#x60; address from any entry to delist it.',
                                  class => 'MailBlocks',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    'local' => {
        datatype => 'ARRAY[MailBlockClickHouse]',
        base_name => 'local',
    ...
    'subject' => {
        datatype => 'ARRAY[MailBlockRspamd]',
        base_name => 'subject',
