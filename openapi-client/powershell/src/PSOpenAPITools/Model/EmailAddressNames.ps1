...
EmailAddressNames<PSCustomObject>
#>

function Initialize-EmailAddressNames {
    [CmdletBinding()]
    Param (
    )

    Process {
        'Creating PSCustomObject: PSOpenAPITools => EmailAddressNames' | Write-Debug
...
Convert from JSON to EmailAddressNames<PSCustomObject>
...
EmailAddressNames<PSCustomObject>
#>
function ConvertFrom-JsonToEmailAddressNames {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EmailAddressNames' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EmailAddressNames
        $AllProperties = ()
