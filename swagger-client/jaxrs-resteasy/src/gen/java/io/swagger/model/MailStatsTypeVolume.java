...
public class MailStatsTypeVolume   {
  private Map<String, Integer> to = new HashMap<String, Integer>();  private Map<String, Integer> from = new HashMap<String, Integer>();  private Map<String, Integer> ip = new HashMap<String, Integer>();
