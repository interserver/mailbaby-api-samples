...
**attachments** | [**List<MailAttachment>**](MailAttachment.md) | Optional list of file attachments.  Each file must be base64-encoded. Include `filename` so recipients see a meaningful attachment name. | [optional] [default to const []]
