...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaJerseyDIServerCodegen", date = "2023-01-10T22:50:01.832471-05:00[America/New_York]")public class MailApi  {
...
,@Parameter(description = "", required=true)  @FormParam("from")  SendMailAdvFrom from
,@Parameter(description = "", required=true)  @FormParam("to")  List<SendMailAdvTo> to
,@Parameter(description = "", required=true)  @FormParam("replyto")  List<SendMailAdvReplyto> replyto
,@Parameter(description = "", required=true)  @FormParam("cc")  List<SendMailAdvCc> cc
,@Parameter(description = "", required=true)  @FormParam("bcc")  List<SendMailAdvBcc> bcc
,@Parameter(description = "", required=true)  @FormParam("attachments")  List<SendMailAdvAttachments> attachments
