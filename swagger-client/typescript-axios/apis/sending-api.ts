...
import { EmailAddressName } from '../models';
...
export const SendingApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        sendAdvMailForm: async (subject: string, body: string, from: EmailAddressName, to: Array<EmailAddressName>, replyto: Array<EmailAddressName>, cc: Array<EmailAddressName>, bcc: Array<EmailAddressName>, attachments: Array<MailAttachment>, id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const SendingApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async sendAdvMailForm(subject: string, body: string, from: EmailAddressName, to: Array<EmailAddressName>, replyto: Array<EmailAddressName>, cc: Array<EmailAddressName>, bcc: Array<EmailAddressName>, attachments: Array<MailAttachment>, id: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<GenericResponse>>> {
...
export const SendingApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async sendAdvMailForm(subject: string, body: string, from: EmailAddressName, to: Array<EmailAddressName>, replyto: Array<EmailAddressName>, cc: Array<EmailAddressName>, bcc: Array<EmailAddressName>, attachments: Array<MailAttachment>, id: number, options?: AxiosRequestConfig): Promise<AxiosResponse<GenericResponse>> {
...
export class SendingApi extends BaseAPI {
     ...
     * @memberof SendingApi
     */
    public async sendAdvMailForm(subject: string, body: string, from: EmailAddressName, to: Array<EmailAddressName>, replyto: Array<EmailAddressName>, cc: Array<EmailAddressName>, bcc: Array<EmailAddressName>, attachments: Array<MailAttachment>, id: number, options?: AxiosRequestConfig) : Promise<AxiosResponse<GenericResponse>> {
