...
OAIDenyRuleNew::OAIDenyRuleNew(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAIDenyRuleNew::OAIDenyRuleNew() {
    this->initializeModel();
}

OAIDenyRuleNew::~OAIDenyRuleNew() {}

void OAIDenyRuleNew::initializeModel() {
...
void OAIDenyRuleNew::fromJson(QString jsonString) {
...
QString OAIDenyRuleNew::asJson() const {
...
bool OAIDenyRuleNew::is_type_Valid() const{
...
bool OAIDenyRuleNew::is_data_Valid() const{
...
bool OAIDenyRuleNew::is_user_Valid() const{
    return m_user_isValid;
}

bool OAIDenyRuleNew::isSet() const {
...
bool OAIDenyRuleNew::isValid() const {
