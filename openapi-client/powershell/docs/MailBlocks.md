...
------------ | ------------- | ------------- | -------------
**VarLocal** | [**MailBlockClickHouse[]**](MailBlockClickHouse.md) | Messages flagged by the &#x60;LOCAL_BL_RCPT&#x60; rspamd rule in the last 5 days. These are messages sent to recipients on a local block list. | 
