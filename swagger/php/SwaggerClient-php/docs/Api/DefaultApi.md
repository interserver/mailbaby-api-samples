...
# **sendAdvMailById**
> \Swagger\Client\Model\GenericResponse sendAdvMailById($body, $id)
...
$body = new \Swagger\Client\Model\SendMail(); // \Swagger\Client\Model\SendMail | 
$id = 789; // int | User ID
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\SendMail**](../Model/SendMail.md)|  |
 **id** | **int**| User ID |
...
# **sendAdvMailById**
> \Swagger\Client\Model\GenericResponse sendAdvMailById($id2, $id)
...
# **sendMailById**
> \Swagger\Client\Model\GenericResponse sendMailById($id, $subject, $body, $to, $to_name, $from, $from_name)
...
try {
    $result = $apiInstance->sendMailById($id, $subject, $body, $to, $to_name, $from, $from_name);
    print_r($result);
} catch (Exception $e) {
