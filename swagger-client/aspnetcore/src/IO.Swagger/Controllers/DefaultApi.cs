...
{ 
    ...
    { 
        ...
        public virtual IActionResult SendMailById([FromRoute][Required]long? id, [FromQuery]string subject, [FromQuery]string body, [FromQuery]string to, [FromQuery]string from)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
