...
use_ok('OpenAPIClient::ServicesApi');

my $api = OpenAPIClient::ServicesApi->new();
isa_ok($api, 'OpenAPIClient::ServicesApi');

#
# get_mail_order_by_id test
#
# uncomment below and update the test
#my $get_mail_order_by_id_id = undef; # replace NULL with a proper value
#my $get_mail_order_by_id_result = $api->get_mail_order_by_id(id => $get_mail_order_by_id_id);
