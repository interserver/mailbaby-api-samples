...
// checks if the EmailAddressNames type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmailAddressNames{}
...
// NewEmailAddressNames instantiates a new EmailAddressNames object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewEmailAddressNames() *EmailAddressNames {
	this := EmailAddressNames{}
	return &this
}

// NewEmailAddressNamesWithDefaults instantiates a new EmailAddressNames object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewEmailAddressNamesWithDefaults() *EmailAddressNames {
	this := EmailAddressNames{}
	return &this
}

func (o EmailAddressNames) MarshalJSON() ([]byte, error) {
...
func (o EmailAddressNames) ToMap() (map[string]interface{}, error) {
...
func (o *EmailAddressNames) UnmarshalJSON(data []byte) (err error) {
	return json.Unmarshal(data, &o.Items)
}

type NullableEmailAddressNames struct {
	value EmailAddressNames
	isSet bool
}

func (v NullableEmailAddressNames) Get() EmailAddressNames {
	return v.value
}

func (v *NullableEmailAddressNames) Set(val EmailAddressNames) {
	v.value = val
	v.isSet = true
}

func (v NullableEmailAddressNames) IsSet() bool {
	return v.isSet
}

func (v *NullableEmailAddressNames) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmailAddressNames(val EmailAddressNames) *NullableEmailAddressNames {
	return &NullableEmailAddressNames{value: val, isSet: true}
}

func (v NullableEmailAddressNames) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmailAddressNames) UnmarshalJSON(src []byte) error {
	v.isSet = true
