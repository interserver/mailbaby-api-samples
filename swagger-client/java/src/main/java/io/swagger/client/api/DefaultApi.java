...
public class DefaultApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call sendMailByIdCall(Long id, String subject, String body, String to, String from, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call sendMailByIdValidateBeforeCall(Long id, String subject, String body, String to, String from, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling sendMailById(Async)");
        }
        
        com.squareup.okhttp.Call call = sendMailByIdCall(id, subject, body, to, from, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public GenericResponse sendMailById(Long id, String subject, String body, String to, String from) throws ApiException {
        ApiResponse<GenericResponse> resp = sendMailByIdWithHttpInfo(id, subject, body, to, from);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<GenericResponse> sendMailByIdWithHttpInfo(Long id, String subject, String body, String to, String from) throws ApiException {
        com.squareup.okhttp.Call call = sendMailByIdValidateBeforeCall(id, subject, body, to, from, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call sendMailByIdAsync(Long id, String subject, String body, String to, String from, final ApiCallback<GenericResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = sendMailByIdValidateBeforeCall(id, subject, body, to, from, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GenericResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
