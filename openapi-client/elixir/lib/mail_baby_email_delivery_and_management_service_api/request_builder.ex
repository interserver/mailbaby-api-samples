...
defmodule MailBabyEmailDeliveryAndManagementServiceAPI.RequestBuilder do
  ...
  defp decode(%Tesla.Env{body: body}, %{}) do
    MailBabyEmailDeliveryAndManagementServiceAPI.Deserializer.jason_decode(body)
  end

  defp decode(%Tesla.Env{body: body}, module) do
    MailBabyEmailDeliveryAndManagementServiceAPI.Deserializer.jason_decode(body, module)
  end
end
