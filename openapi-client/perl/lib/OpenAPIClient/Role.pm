...
has _cfg => ( is => 'ro',
              isa => 'OpenAPIClient::Configuration',
              default => sub { OpenAPIClient::Configuration->new() },
              );
...
sub _build_af {
    ...
    return OpenAPIClient::ApiFactory->new(%args);
}
...
=head2 MailBaby Email Delivery and Management Service API version: 1.3.0
