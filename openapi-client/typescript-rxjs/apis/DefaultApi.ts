...
export class DefaultApi extends BaseAPI {
     ...
     * Sends an Email
     */
    sendMailById({ id, subject, body, to, from }: SendMailByIdRequest): Observable<GenericResponse>
    sendMailById({ id, subject, body, to, from }: SendMailByIdRequest, opts?: OperationOpts): Observable<RawAjaxResponse<GenericResponse>>
    sendMailById({ id, subject, body, to, from }: SendMailByIdRequest, opts?: OperationOpts): Observable<GenericResponse | RawAjaxResponse<GenericResponse>> {
