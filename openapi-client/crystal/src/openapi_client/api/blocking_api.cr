...
module OpenAPIClient
  class BlockingApi
    ...
    def add_rule(_type : String, data : String, user : String?)
    ...
    def add_rule_with_http_info(_type : String, data : String, user : String?)
      ...
      # verify enum value
      allowable_values = ["domain", "email", "startswith"]
    ...
    # @return [GenericResponse]
    def delist_block(email_address : EmailAddress)
      data, _status_code, _headers = delist_block_with_http_info(email_address)
      data
    end
    ...
    # @param email_address [EmailAddress] 
    # @return [Array<(GenericResponse, Integer, Hash)>] GenericResponse data, response status code and response headers
    def delist_block_with_http_info(email_address : EmailAddress)
      if @api_client.config.debugging
        Log.debug {"Calling API: BlockingApi.delist_block ..."}
      end
      # verify the required parameter "email_address" is set
      if @api_client.config.client_side_validation && email_address.nil?
        raise ArgumentError.new("Missing the required parameter 'email_address' when calling BlockingApi.delist_block")
      end
      # resource path
      ...
      # http body (model)
      post_body = email_address.to_json
