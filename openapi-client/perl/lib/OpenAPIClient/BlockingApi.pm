...
# @param string $user Optional SMTP username of the mail order to associate this rule with (e.g. &#x60;mb20682&#x60;).  If omitted the first active order is used.  Valid usernames are the &#x60;username&#x60; values returned by &#x60;GET /mail&#x60;. (optional)
{
    my $params = {
    'type' => {
        data_type => 'string',
...
#
# @param EmailAddressParam $email_address_param  (required)
{
    my $params = {
    'email_address_param' => {
        data_type => 'EmailAddressParam',
        description => '',
        required => '1',
    },
    };
...
sub delist_block {
    ...
    unless (exists $args{'email_address_param'}) {
      croak("Missing the required parameter 'email_address_param' when calling delist_block");
    }
    ...
    my $_body_data;
    # body params
    if ( exists $args{'email_address_param'}) {
        $_body_data = $args{'email_address_param'};
    }
