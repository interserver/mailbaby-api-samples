...
model.instance <- SendMailAdv$new()
...
test_that("from", {
  # tests for the property `from` (array[SendMailAdvFrom])
...
test_that("to", {
  # tests for the property `to` (array[MailContact])
...
test_that("replyto", {
  # tests for the property `replyto` (array[MailContact])
...
test_that("cc", {
  # tests for the property `cc` (array[MailContact])
...
test_that("bcc", {
  # tests for the property `bcc` (array[MailContact])
