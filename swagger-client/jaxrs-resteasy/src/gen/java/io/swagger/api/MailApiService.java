...
public interface MailApiService {
      ...
      Response delistBlock(EmailAddress body,SecurityContext securityContext) throws NotFoundException;
      ...
      Response getStats(SecurityContext securityContext) throws NotFoundException;
      Response sendAdvMail(String subject,String body,EmailAddressName from,List<EmailAddressName> to,List<EmailAddressName> replyto,List<EmailAddressName> cc,List<EmailAddressName> bcc,List<MailAttachment> attachments,Long id,SecurityContext securityContext) throws NotFoundException;
      ...
      Response viewMailLog(Long id,String origin,String mx,String from,String to,String subject,String mailid,Integer skip,Integer limit,Long startDate,Long endDate,SecurityContext securityContext) throws NotFoundException;
}
