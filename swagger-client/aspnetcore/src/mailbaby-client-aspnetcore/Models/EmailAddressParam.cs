...
namespace mailbaby-client-aspnetcore.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmailAddressParam : IEquatable<EmailAddressParam>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((EmailAddressParam)obj);
        }

        /// <summary>
        /// Returns true if EmailAddressParam instances are equal
        /// </summary>
        /// <param name="other">Instance of EmailAddressParam to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailAddressParam other)
        {
        ...
        public static bool operator ==(EmailAddressParam left, EmailAddressParam right)
        {
