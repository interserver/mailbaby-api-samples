...
defmodule MailBabyAPI.Api.Default do
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec get_mail_orders(Tesla.Env.client, keyword()) :: {:ok, list(MailBabyAPI.Model.MailOrder.t)} | {:ok, MailBabyAPI.Model.ErrorResposne.t} | {:error, Tesla.Env.t}
  def get_mail_orders(connection, _opts \\ []) do
    ...
    |> evaluate_response([
      { 200, [%MailBabyAPI.Model.MailOrder{}]},
      { 401, %MailBabyAPI.Model.ErrorResposne{}}
    ])
  end
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec place_mail_order(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, MailBabyAPI.Model.ErrorResposne.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec send_adv_mail_by_id(Tesla.Env.client, integer(), MailBabyAPI.Model.SendMail.t, keyword()) :: {:ok, nil} | {:ok, MailBabyAPI.Model.ErrorResposne.t} | {:ok, MailBabyAPI.Model.ErrorResponse.t} | {:ok, MailBabyAPI.Model.GenericResponse.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec send_mail_by_id(Tesla.Env.client, integer(), keyword()) :: {:ok, nil} | {:ok, MailBabyAPI.Model.ErrorResposne.t} | {:ok, MailBabyAPI.Model.ErrorResponse.t} | {:ok, MailBabyAPI.Model.GenericResponse.t} | {:error, Tesla.Env.t}
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec validate_mail_order(Tesla.Env.client, keyword()) :: {:ok, nil} | {:ok, MailBabyAPI.Model.ErrorResposne.t} | {:error, Tesla.Env.t}
