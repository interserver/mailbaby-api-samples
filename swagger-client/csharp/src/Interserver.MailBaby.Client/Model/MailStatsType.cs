...
namespace Interserver.MailBaby.Client.Model
{
        ...
        public partial class MailStatsType :  IEquatable<MailStatsType>, IValidatableObject
    {
        ...
        public MailStatsType(TimeEnum? time = TimeEnum._1h, int? usage = default(int?), string currency = default(string), double? cost = default(double?), int? received = default(int?), int? sent = default(int?), MailStatsVolume volume = default(MailStatsVolume))
        {
