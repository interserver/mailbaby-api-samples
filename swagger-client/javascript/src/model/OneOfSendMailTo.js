...
/**
 * The OneOfSendMailTo model module.
 * @module model/OneOfSendMailTo
 * @version 1.4.0
 */
export default class OneOfSendMailTo {
  /**
   * Constructs a new <code>OneOfSendMailTo</code>.
   * @alias module:model/OneOfSendMailTo
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>OneOfSendMailTo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/OneOfSendMailTo} obj Optional instance to populate.
   * @return {module:model/OneOfSendMailTo} The populated <code>OneOfSendMailTo</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new OneOfSendMailTo();
    }
    return obj;
  }
}
