...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SendMailAdv : IEquatable<SendMailAdv>, IValidatableObject
    {
        ...
        public SendMailAdv(string subject = default(string), string body = default(string), List<SendMailAdvFrom> from = default(List<SendMailAdvFrom>), List<MailContact> to = default(List<MailContact>), long id = default(long), List<MailContact> replyto = default(List<MailContact>), List<MailContact> cc = default(List<MailContact>), List<MailContact> bcc = default(List<MailContact>), List<MailAttachment> attachments = default(List<MailAttachment>))
        {
            // to ensure "subject" is required (not null)
            this.Subject = subject ?? throw new ArgumentNullException("subject is a required property for SendMailAdv and cannot be null");
            // to ensure "body" is required (not null)
            this.Body = body ?? throw new ArgumentNullException("body is a required property for SendMailAdv and cannot be null");
            // to ensure "from" is required (not null)
            this.From = from ?? throw new ArgumentNullException("from is a required property for SendMailAdv and cannot be null");
            // to ensure "to" is required (not null)
            this.To = to ?? throw new ArgumentNullException("to is a required property for SendMailAdv and cannot be null");
            this.Id = id;
