...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailBabyEmailDeliveryAndManagementServiceApi.MailStatsVolume();
  });
  ...
  describe('MailStatsVolume', function() {
    it('should create an instance of MailStatsVolume', function() {
      // uncomment below and update the code to test MailStatsVolume
      //var instance = new MailBabyEmailDeliveryAndManagementServiceApi.MailStatsVolume();
      //expect(instance).to.be.a(MailBabyEmailDeliveryAndManagementServiceApi.MailStatsVolume);
    });
