...
public interface HistoryApi  {
    ...
    @Path("/mail/log")
    @Produces({ "application/json" })
    @Operation(summary = "displays the mail log", tags={ "History" })
    @ApiResponses(value = { 
    ...
    public MailLog viewMailLog(@QueryParam("id") Long id, @QueryParam("origin") String origin, @QueryParam("mx") String mx, @QueryParam("from") String from, @QueryParam("to") String to, @QueryParam("subject") String subject, @QueryParam("mailid") String mailid, @QueryParam("skip") @Min(0) @DefaultValue("0") Integer skip, @QueryParam("limit") @Min(1) @Max(10000) @DefaultValue("100") Integer limit, @QueryParam("startDate") @Min(0L) @Max(9999999999L) Long startDate, @QueryParam("endDate") @Min(0L) @Max(9999999999L) Long endDate, @QueryParam("replyto") String replyto, @QueryParam("headerfrom") String headerfrom);
}
