...
pub async fn view_mail_log(configuration: &configuration::Configuration, id: Option<i64>, search: Option<&str>, skip: Option<i32>, limit: Option<i32>) -> Result<crate::models::MailLog, Error<ViewMailLogError>> {
    let local_var_configuration = configuration;
