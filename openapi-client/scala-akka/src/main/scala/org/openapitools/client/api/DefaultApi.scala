...
class DefaultApi(baseUrl: String) {
   ...
   */
  def viewMailLog(id: Option[Long] = None, search: Option[String] = None, skip: Option[Int] = None, limit: Option[Int] = None, startDate: Option[Long] = None, endDate: Option[Long] = None)(implicit apiKey: ApiKeyValue): ApiRequest[MailLog] =
