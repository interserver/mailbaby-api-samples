...
feature -- API Access
	...
	view_mail_log (id: INTEGER_64; search: STRING_32; skip: INTEGER_32; limit: INTEGER_32; start_date: INTEGER_64; end_date: INTEGER_64): detachable MAIL_LOG
			-- displays the mail log
			-- By passing in the appropriate options, you can search for available inventory in the system 
			-- 
			-- argument: id The ID of your mail order this will be sent through. (optional, default to null)
			-- 
			-- argument: search pass an optional search string for looking up inventory (optional, default to null)
			-- 
