...
void
SendMailAdv_bcc_inner::__cleanup()
{
	//if(email != NULL) {
	//
	//delete email;
...
void
SendMailAdv_bcc_inner::fromJson(char* jsonStr)
{
...
SendMailAdv_bcc_inner::SendMailAdv_bcc_inner(char* json)
{
	this->fromJson(json);
}
