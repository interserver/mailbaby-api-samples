...
Describe -tag 'PSOpenAPITools' -name 'MailStatsType' {
    Context 'MailStatsType' {
        It 'Initialize-MailStatsType' {
            ...
            #$NewObject = Initialize-MailStatsType -Time "TEST_VALUE" -Usage "TEST_VALUE" -Currency "TEST_VALUE" -Cost "TEST_VALUE" -Received "TEST_VALUE" -Sent "TEST_VALUE" -Volume "TEST_VALUE"
