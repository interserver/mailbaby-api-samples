...
-- email_address_names class
local email_address_names = {}
local email_address_names_mt = {
	__name = "email_address_names";
	__index = email_address_names;
}

local function cast_email_address_names(t)
	return setmetatable(t, email_address_names_mt)
end

local function new_email_address_names()
	return cast_email_address_names({
	})
end

return {
	cast = cast_email_address_names;
	new = new_email_address_names;
}
