...
-- email_address_param class
local email_address_param = {}
local email_address_param_mt = {
	__name = "email_address_param";
	__index = email_address_param;
}

local function cast_email_address_param(t)
	return setmetatable(t, email_address_param_mt)
end

local function new_email_address_param(email)
	return cast_email_address_param({
		["email"] = email;
	})
end

return {
	cast = cast_email_address_param;
	new = new_email_address_param;
}
