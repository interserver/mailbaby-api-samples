...
import org.openapitools.client.models.EmailAddress
...
class BlockingApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun delistBlock(emailAddress: EmailAddress) : GenericResponse {
        val localVarResponse = delistBlockWithHttpInfo(emailAddress = emailAddress)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun delistBlockWithHttpInfo(emailAddress: EmailAddress) : ApiResponse<GenericResponse?> {
        val localVariableConfig = delistBlockRequestConfig(emailAddress = emailAddress)

        return request<EmailAddress, GenericResponse>(
            localVariableConfig
        )
    }
     ...
     * @return RequestConfig
     */
    fun delistBlockRequestConfig(emailAddress: EmailAddress) : RequestConfig<EmailAddress> {
        val localVariableBody = emailAddress
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
