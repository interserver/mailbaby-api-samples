...
public class SendingApi {
     ...
     */
    public okhttp3.Call sendAdvMailCall(String subject, String body, EmailAddressTypes from, EmailAddressesTypes to, EmailAddressesTypes replyto, EmailAddressesTypes cc, EmailAddressesTypes bcc, List<MailAttachment> attachments, Long id, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call sendAdvMailValidateBeforeCall(String subject, String body, EmailAddressTypes from, EmailAddressesTypes to, EmailAddressesTypes replyto, EmailAddressesTypes cc, EmailAddressesTypes bcc, List<MailAttachment> attachments, Long id, final ApiCallback _callback) throws ApiException {
     ...
     */
    public okhttp3.Call sendAdvMailAsync(String subject, String body, EmailAddressTypes from, EmailAddressesTypes to, EmailAddressesTypes replyto, EmailAddressesTypes cc, EmailAddressesTypes bcc, List<MailAttachment> attachments, Long id, final ApiCallback<GenericResponse> _callback) throws ApiException {
