...
*OpenAPIClient.APIs.BlockingApi* | [**DeleteRule**](BlockingApi.md#deleterule) | **DELETE** /mail/rules/{ruleId} | Removes a deny mail rule
*OpenAPIClient.APIs.BlockingApi* | [**DelistBlock**](BlockingApi.md#delistblock) | **POST** /mail/blocks/delete | Removes an email address from the block lists
...
*OpenAPIClient.APIs.SendingApi* | [**RawMail**](SendingApi.md#rawmail) | **POST** /mail/rawsend | Sends a raw RFC 822 email
...
*OpenAPIClient.APIs.ServicesApi* | [**GetMailOrderById**](ServicesApi.md#getmailorderbyid) | **GET** /mail/{id} | Displays details for a single mail order
...
## Documentation For Models
 ...
 - [OpenAPIClient.Models.EmailAddressNames](EmailAddressNames.md)
 - [OpenAPIClient.Models.EmailAddressParam](EmailAddressParam.md)
 ...
 - [OpenAPIClient.Models.MailOrderDetail](MailOrderDetail.md)
 - [OpenAPIClient.Models.MailStatsType](MailStatsType.md)
 - [OpenAPIClient.Models.MailStatsVolume](MailStatsVolume.md)
 - [OpenAPIClient.Models.SendMail](SendMail.md)
 - [OpenAPIClient.Models.SendMailAdv](SendMailAdv.md)
 - [OpenAPIClient.Models.SendMailRaw](SendMailRaw.md)
 - [OpenAPIClient.Models.SendMailTo](SendMailTo.md)
