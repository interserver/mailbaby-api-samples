...
defmodule MailBabyEmailDeliveryAndManagementServiceAPI.Connection do
  @moduledoc """
  Handle Tesla connections for MailBabyEmailDeliveryAndManagementServiceAPI.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, MailBabyEmailDeliveryAndManagementServiceAPI.Connection,
        base_url: "https://api.mailbaby.net",
        adapter: Tesla.Adapter.Hackney

  The default base URL can also be set as:

      config :mail_baby_email_delivery_and_management_service_api,
        :base_url, "https://api.mailbaby.net"
  """
  ...
  @doc """
  Configure a MailBabyEmailDeliveryAndManagementServiceAPI client.

  ### Parameters

  - `options`: an optional keyword list of MailBabyEmailDeliveryAndManagementServiceAPI.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:mail_baby_email_delivery_and_management_service_api, :base_url, @default_base_url)
      )
