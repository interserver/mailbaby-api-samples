...
namespace mailbaby-client-csharp.Api
{
        ...
        public interface IHistoryApi : IApiAccessor
    {
        ...
        /// <param name="delivered">Limiting the emails to wether or not they were delivered. (optional)</param>
        ...
        ApiResponse<MailLog> ViewMailLogWithHttpInfo (long? id = null, string origin = null, string mx = null, string from = null, string to = null, string subject = null, string mailid = null, int? skip = null, int? limit = null, long? startDate = null, long? endDate = null, string replyto = null, string headerfrom = null, string delivered = null);
        ...
        public partial class HistoryApi : IHistoryApi
    {
        ...
        /// <param name="delivered">Limiting the emails to wether or not they were delivered. (optional)</param>
        /// <returns>MailLog</returns>
        public MailLog ViewMailLog (long? id = null, string origin = null, string mx = null, string from = null, string to = null, string subject = null, string mailid = null, int? skip = null, int? limit = null, long? startDate = null, long? endDate = null, string replyto = null, string headerfrom = null, string delivered = null)
        {
             ApiResponse<MailLog> localVarResponse = ViewMailLogWithHttpInfo(id, origin, mx, from, to, subject, mailid, skip, limit, startDate, endDate, replyto, headerfrom, delivered);
             return localVarResponse.Data;
        }
        ...
        /// <param name="delivered">Limiting the emails to wether or not they were delivered. (optional)</param>
        /// <returns>ApiResponse of MailLog</returns>
        public ApiResponse< MailLog > ViewMailLogWithHttpInfo (long? id = null, string origin = null, string mx = null, string from = null, string to = null, string subject = null, string mailid = null, int? skip = null, int? limit = null, long? startDate = null, long? endDate = null, string replyto = null, string headerfrom = null, string delivered = null)
        {
        ...
        {
             ApiResponse<MailLog> localVarResponse = await ViewMailLogAsyncWithHttpInfo(id, origin, mx, from, to, subject, mailid, skip, limit, startDate, endDate, replyto, headerfrom, delivered);
             return localVarResponse.Data;
