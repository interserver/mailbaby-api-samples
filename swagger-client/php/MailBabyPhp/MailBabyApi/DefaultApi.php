...
namespace Interserver\Mailbaby\MailBabyApi;
...
class DefaultApi
{
     ...
     * @return \Interserver\Mailbaby\MailBabyModel\MailOrder
     */
     ...
     * @throws \Interserver\Mailbaby\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Interserver\Mailbaby\MailBabyModel\MailOrder, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMailByIdWithHttpInfo($id)
    {
        $returnType = '\Interserver\Mailbaby\MailBabyModel\MailOrder';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Interserver\Mailbaby\MailBabyModel\MailOrder',
     ...
     * @throws \Interserver\Mailbaby\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Interserver\Mailbaby\MailBabyModel\MailOrders
     */
     ...
     * @throws \Interserver\Mailbaby\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Interserver\Mailbaby\MailBabyModel\MailOrders, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMailOrdersWithHttpInfo()
    {
        $returnType = '\Interserver\Mailbaby\MailBabyModel\MailOrders';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Interserver\Mailbaby\MailBabyModel\MailOrders',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Interserver\Mailbaby\MailBabyModel\Error',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * places a mail order
     *
     * @param  \Interserver\Mailbaby\MailBabyModel\MailOrder $body Inventory item to add (optional)
     *
     * @throws \Interserver\Mailbaby\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * @throws \Interserver\Mailbaby\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Interserver\Mailbaby\MailBabyModel\GenericResponse
     */
     ...
     * @throws \Interserver\Mailbaby\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Interserver\Mailbaby\MailBabyModel\GenericResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendMailByIdWithHttpInfo($id, $subject = null, $body = null, $to = null, $from = null)
    {
        $returnType = '\Interserver\Mailbaby\MailBabyModel\GenericResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Interserver\Mailbaby\MailBabyModel\GenericResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Interserver\Mailbaby\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Interserver\Mailbaby\MailBabyModel\MailLog[]
     */
     ...
     * @throws \Interserver\Mailbaby\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Interserver\Mailbaby\MailBabyModel\MailLog[], HTTP status code, HTTP response headers (array of strings)
     */
    public function viewMailLogByIdWithHttpInfo($id, $searchString = null, $skip = null, $limit = null)
    {
        $returnType = '\Interserver\Mailbaby\MailBabyModel\MailLog[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Interserver\Mailbaby\MailBabyModel\MailLog[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function viewMailLogByIdRequest($id, $searchString = null, $skip = null, $limit = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
