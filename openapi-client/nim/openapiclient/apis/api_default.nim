...
import ../models/model_get_mail_orders_200_response_inner
...
proc getMailOrders*(httpClient: HttpClient): (Option[seq[getMailOrders_200_response_inner]], Response) =
  ## displays a list of mail service orders

  let response = httpClient.get(basepath & "/mail")
  constructResult[seq[getMailOrders_200_response_inner]](response)
...
proc viewMailLog*(httpClient: HttpClient, id: int64, search: string, skip: int, limit: int, startDate: int64, endDate: int64): (Option[MailLog], Response) =
  ## displays the mail log
  let query_for_api_call = encodeQuery([
    ("id", $id), # The ID of your mail order this will be sent through.
    ("search", $search), # pass an optional search string for looking up inventory
