...
function Initialize-Body1 {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Body1' | Write-Debug
...
Convert from JSON to Body1<PSCustomObject>
...
Body1<PSCustomObject>
#>
function ConvertFrom-JsonToBody1 {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Body1' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Body1
