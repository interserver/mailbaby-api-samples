...
class HistoryApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : MailLog (Paginated list of mail log entries)
   ...
   */
  def viewMailLog(apiKeyHeader: String)(id: Option[Long] = None, origin: Option[String] = None, mx: Option[String] = None, from: Option[String] = None, to: Option[String] = None, subject: Option[String] = None, mailid: Option[String] = None, messageId: Option[String] = None, replyto: Option[String] = None, headerfrom: Option[String] = None, delivered: Option[Int] = None, skip: Option[Int] = None, limit: Option[Int] = None, startDate: Option[Long] = None, endDate: Option[Long] = None): Request[Either[ResponseException[String, Exception], MailLog]] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/mail/log?id=${ id }&origin=${ origin }&mx=${ mx }&from=${ from }&to=${ to }&subject=${ subject }&mailid=${ mailid }&messageId=${ messageId }&replyto=${ replyto }&headerfrom=${ headerfrom }&delivered=${ delivered }&skip=${ skip }&limit=${ limit }&startDate=${ startDate }&endDate=${ endDate }")
      .contentType("application/json")
      .header("X-API-KEY", apiKeyHeader)
