## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Mail Baby API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Mail Baby API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | MailBaby                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | mail-baby                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | MailBabyConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | MailBabyRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| MailBaby.Client    | use the "dispatch" functions to send requests       |
| MailBaby.Core      | core funcions, config and request types             |
| MailBaby.API       | construct api requests                              |
| MailBaby.Model     | describes api models                                |
| MailBaby.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| MailBaby.ModelLens | lenses for model fields                             |
| MailBaby.Logging   | logging functions and utils                         |
