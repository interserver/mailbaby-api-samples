...
$body = new \Interserver\Mailbaby\Model\DenyRuleNew(); // \Interserver\Mailbaby\Model\DenyRuleNew | Fields required to create a new email deny rule.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Interserver\Mailbaby\Model\DenyRuleNew**](../Model/DenyRuleNew.md)| Fields required to create a new email deny rule. |
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Interserver\Mailbaby\Model\EmailAddressParam**](../Model/EmailAddressParam.md)|  |
