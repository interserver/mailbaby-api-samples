...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IDefaultApiSync : IApiAccessor
    {
        ...
        MailLog ViewMailLog(long? id = default(long?), string origin = default(string), string mx = default(string), string from = default(string), string to = default(string), string subject = default(string), string mailid = default(string), int? skip = default(int?), int? limit = default(int?), long? startDate = default(long?), long? endDate = default(long?), int operationIndex = 0);
        ...
        ApiResponse<MailLog> ViewMailLogWithHttpInfo(long? id = default(long?), string origin = default(string), string mx = default(string), string from = default(string), string to = default(string), string subject = default(string), string mailid = default(string), int? skip = default(int?), int? limit = default(int?), long? startDate = default(long?), long? endDate = default(long?), int operationIndex = 0);
    ...
    public partial class DefaultApi : IDefaultApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>MailLog</returns>
        public MailLog ViewMailLog(long? id = default(long?), string origin = default(string), string mx = default(string), string from = default(string), string to = default(string), string subject = default(string), string mailid = default(string), int? skip = default(int?), int? limit = default(int?), long? startDate = default(long?), long? endDate = default(long?), int operationIndex = 0)
        {
            Org.OpenAPITools.Client.ApiResponse<MailLog> localVarResponse = ViewMailLogWithHttpInfo(id, origin, mx, from, to, subject, mailid, skip, limit, startDate, endDate);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of MailLog</returns>
        public Org.OpenAPITools.Client.ApiResponse<MailLog> ViewMailLogWithHttpInfo(long? id = default(long?), string origin = default(string), string mx = default(string), string from = default(string), string to = default(string), string subject = default(string), string mailid = default(string), int? skip = default(int?), int? limit = default(int?), long? startDate = default(long?), long? endDate = default(long?), int operationIndex = 0)
        {
            Org.OpenAPITools.Client.RequestOptions localVarRequestOptions = new Org.OpenAPITools.Client.RequestOptions();
            ...
            if (mx != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "mx", mx));
            }
            if (from != null)
            {
            ...
            if (mailid != null)
            {
                localVarRequestOptions.QueryParameters.Add(Org.OpenAPITools.Client.ClientUtils.ParameterToMultiMap("", "mailid", mailid));
            }
            if (skip != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of MailLog</returns>
        public async System.Threading.Tasks.Task<MailLog> ViewMailLogAsync(long? id = default(long?), string origin = default(string), string mx = default(string), string from = default(string), string to = default(string), string subject = default(string), string mailid = default(string), int? skip = default(int?), int? limit = default(int?), long? startDate = default(long?), long? endDate = default(long?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Org.OpenAPITools.Client.ApiResponse<MailLog> localVarResponse = await ViewMailLogWithHttpInfoAsync(id, origin, mx, from, to, subject, mailid, skip, limit, startDate, endDate, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
