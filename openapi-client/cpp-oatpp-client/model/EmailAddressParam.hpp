...
#ifndef EmailAddressParam_H_
#define EmailAddressParam_H_
 ...
 */
class EmailAddressParam : public oatpp::DTO {

  DTO_INIT(EmailAddressParam, DTO /* Extends */)
