...
export class ServicesService {
     ...
     */
    public getMailOrderById(id: number, observe?: 'body', headers?: Headers): Observable<MailOrderDetail>;
    public getMailOrderById(id: number, observe?: 'response', headers?: Headers): Observable<HttpResponse<MailOrderDetail>>;
    public getMailOrderById(id: number, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<MailOrderDetail>> = this.httpClient.get(`${this.basePath}/mail/${encodeURIComponent(String(id))}`, headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <MailOrderDetail>(httpResponse.response))
               );
        }
        return response;
    }
