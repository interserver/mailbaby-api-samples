...
void
SendMailAdv_cc_inner::__cleanup()
{
	//if(email != NULL) {
	//
	//delete email;
...
void
SendMailAdv_cc_inner::fromJson(char* jsonStr)
{
...
SendMailAdv_cc_inner::SendMailAdv_cc_inner(char* json)
{
	this->fromJson(json);
}
