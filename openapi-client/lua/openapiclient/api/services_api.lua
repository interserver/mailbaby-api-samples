...
local openapiclient_mail_order_detail = require "openapiclient.model.mail_order_detail"
...
function services_api:get_mail_order_by_id(id)
	...
	if http_status:sub(1,1) == "2" then
		...
		return openapiclient_mail_order_detail.cast(result), headers
	else
		local body, err, errno2 = stream:get_body_as_string()
		if not body then
			return nil, err, errno2
