...
OAISendMailTo::OAISendMailTo(QString json) {
    this->initializeModel();
    this->fromJson(json);
}

OAISendMailTo::OAISendMailTo() {
    this->initializeModel();
}

OAISendMailTo::~OAISendMailTo() {}

void OAISendMailTo::initializeModel() {

}

void OAISendMailTo::fromJson(QString jsonString) {
...
void OAISendMailTo::fromJsonObject(QJsonObject json) {

}

QString OAISendMailTo::asJson() const {
...
QJsonObject OAISendMailTo::asJsonObject() const {
    QJsonObject obj;
    return obj;
}

bool OAISendMailTo::isSet() const {
...
bool OAISendMailTo::isValid() const {
