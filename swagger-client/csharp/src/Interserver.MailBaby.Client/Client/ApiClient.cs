...
namespace Interserver.MailBaby.Client.Client
{
    /// <summary>
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = Interserver.MailBaby.Client.Client.Configuration.Default;
        ...
        {
            Configuration = config ?? Interserver.MailBaby.Client.Client.Configuration.Default;
