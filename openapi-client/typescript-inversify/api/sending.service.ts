...
export class SendingService {
     ...
     */
    public sendMail(to: string, from: string, subject: string, body: string, id?: number, observe?: 'body', headers?: Headers): Observable<GenericResponse>;
    public sendMail(to: string, from: string, subject: string, body: string, id?: number, observe?: 'response', headers?: Headers): Observable<HttpResponse<GenericResponse>>;
    public sendMail(to: string, from: string, subject: string, body: string, id?: number, observe: any = 'body', headers: Headers = {}): Observable<any> {
        if (to === null || to === undefined){
