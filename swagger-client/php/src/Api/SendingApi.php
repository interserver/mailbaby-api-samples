...
class SendingApi
{
     ...
     */
    public function rawMail($body)
    {
        list($response) = $this->rawMailWithHttpInfo($body);
        return $response;
    }
     ...
     */
    public function rawMailWithHttpInfo($body)
    {
        $returnType = '\Interserver\Mailbaby\Model\GenericResponse';
        $request = $this->rawMailRequest($body);
     ...
     */
    public function rawMailAsync($body)
    {
        return $this->rawMailAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function rawMailAsyncWithHttpInfo($body)
    {
        $returnType = '\Interserver\Mailbaby\Model\GenericResponse';
        $request = $this->rawMailRequest($body);
     ...
     */
    protected function rawMailRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling rawMail'
            );
        }
     ...
     * @param  \Interserver\Mailbaby\Model\EmailAddressesTypes $replyto replyto (required)
     * @param  \Interserver\Mailbaby\Model\EmailAddressesTypes $cc cc (required)
     * @param  \Interserver\Mailbaby\Model\EmailAddressesTypes $bcc bcc (required)
     ...
     * @param  \Interserver\Mailbaby\Model\EmailAddressesTypes $replyto (required)
     * @param  \Interserver\Mailbaby\Model\EmailAddressesTypes $cc (required)
     * @param  \Interserver\Mailbaby\Model\EmailAddressesTypes $bcc (required)
