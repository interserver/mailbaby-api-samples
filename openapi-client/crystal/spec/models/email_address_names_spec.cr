...
# Unit tests for OpenAPIClient::EmailAddressNames
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe OpenAPIClient::EmailAddressNames do

  describe "test an instance of EmailAddressNames" do
    skip "should create an instance of EmailAddressNames" do
      #instance = OpenAPIClient::EmailAddressNames.new
      #expect(instance).to be_instance_of(OpenAPIClient::EmailAddressNames)
    end
  end
end
