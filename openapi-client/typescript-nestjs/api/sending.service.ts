...
export class SendingService {
     ...
     */
    public sendMail(to: string, _from: string, subject: string, body: string, id?: number, sendMailOpts?: { config?: AxiosRequestConfig }): Observable<AxiosResponse<GenericResponse>>;
    public sendMail(to: string, _from: string, subject: string, body: string, id?: number, sendMailOpts?: { config?: AxiosRequestConfig }): Observable<any> {
        if (to === null || to === undefined) {
