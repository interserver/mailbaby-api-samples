...
feature -- API Access
	...
	mail_order_by_id (id: INTEGER_64): detachable MAIL_ORDER_DETAIL
			...
			-- 
			-- argument: id The numeric ID of the mail order. (required)
			-- 
			-- 
			-- Result MAIL_ORDER_DETAIL
		require
		local
  			l_path: STRING
		...
		do
			...
			elseif attached { MAIL_ORDER_DETAIL } l_response.data ({ MAIL_ORDER_DETAIL }) as l_data then
				Result := l_data
			else
