...
#ifndef OAIMailOrderDetail_H
#define OAIMailOrderDetail_H
...
class OAIMailOrderDetail : public OAIObject {
public:
    OAIMailOrderDetail();
    OAIMailOrderDetail(QString json);
    ~OAIMailOrderDetail() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMailOrderDetail)

#endif // OAIMailOrderDetail_H
