  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`email`)) {
        EmailAddressParamObject[['email']] <- self$`email`
      }

      EmailAddressParamObject
    },
    fromJSON = function(EmailAddressParamJson) {
      EmailAddressParamObject <- jsonlite::fromJSON(EmailAddressParamJson)
      if (!is.null(EmailAddressParamObject$`email`)) {
        self$`email` <- EmailAddressParamObject$`email`
      }
    },
    ...
    fromJSONString = function(EmailAddressParamJson) {
      EmailAddressParamObject <- jsonlite::fromJSON(EmailAddressParamJson)
      self$`email` <- EmailAddressParamObject$`email`
    }
  )
