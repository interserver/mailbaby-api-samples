...
class DefaultApi
{
     ...
     * @return \Interserver\Mailbaby\Model\InlineResponse200[]
     */
     ...
     * @throws \Interserver\Mailbaby\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Interserver\Mailbaby\Model\InlineResponse200[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getMailOrdersWithHttpInfo()
    {
        $returnType = '\Interserver\Mailbaby\Model\InlineResponse200[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Interserver\Mailbaby\Model\InlineResponse200[]',
     ...
     *
     * @param  \Interserver\Mailbaby\Model\SendMailAdv $body body (required)
     *
     * @throws \Interserver\Mailbaby\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Interserver\Mailbaby\Model\GenericResponse
     */
    public function sendAdvMail($body)
    {
        list($response) = $this->sendAdvMailWithHttpInfo($body);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendAdvMailAsync($body)
    {
        return $this->sendAdvMailAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendAdvMailAsyncWithHttpInfo($body)
    {
        $returnType = '\Interserver\Mailbaby\Model\GenericResponse';
        $request = $this->sendAdvMailRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function sendAdvMailRequest($body)
    {
     ...
     * @param  \Interserver\Mailbaby\Model\SendMailAdvFrom $from from (required)
     * @param  \Interserver\Mailbaby\Model\SendMailAdvTo[] $to to (required)
     * @param  \Interserver\Mailbaby\Model\SendMailAdvReplyto[] $replyto replyto (required)
     * @param  \Interserver\Mailbaby\Model\SendMailAdvCc[] $cc cc (required)
     * @param  \Interserver\Mailbaby\Model\SendMailAdvBcc[] $bcc bcc (required)
     * @param  \Interserver\Mailbaby\Model\SendMailAdvAttachments[] $attachments attachments (required)
     ...
     * @return \Interserver\Mailbaby\Model\GenericResponse
     */
    public function sendAdvMail($subject, $body, $from, $to, $replyto, $cc, $bcc, $attachments, $id)
    {
        list($response) = $this->sendAdvMailWithHttpInfo($subject, $body, $from, $to, $replyto, $cc, $bcc, $attachments, $id);
        return $response;
    }
     ...
     * @param  \Interserver\Mailbaby\Model\SendMailAdvFrom $from (required)
     * @param  \Interserver\Mailbaby\Model\SendMailAdvTo[] $to (required)
     * @param  \Interserver\Mailbaby\Model\SendMailAdvReplyto[] $replyto (required)
     * @param  \Interserver\Mailbaby\Model\SendMailAdvCc[] $cc (required)
     * @param  \Interserver\Mailbaby\Model\SendMailAdvBcc[] $bcc (required)
     * @param  \Interserver\Mailbaby\Model\SendMailAdvAttachments[] $attachments (required)
     ...
     * @return array of \Interserver\Mailbaby\Model\GenericResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendAdvMailWithHttpInfo($subject, $body, $from, $to, $replyto, $cc, $bcc, $attachments, $id)
    {
        $returnType = '\Interserver\Mailbaby\Model\GenericResponse';
        $request = $this->sendAdvMailRequest($subject, $body, $from, $to, $replyto, $cc, $bcc, $attachments, $id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendAdvMailAsync($subject, $body, $from, $to, $replyto, $cc, $bcc, $attachments, $id)
    {
        return $this->sendAdvMailAsyncWithHttpInfo($subject, $body, $from, $to, $replyto, $cc, $bcc, $attachments, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendAdvMailAsyncWithHttpInfo($subject, $body, $from, $to, $replyto, $cc, $bcc, $attachments, $id)
    {
        $returnType = '\Interserver\Mailbaby\Model\GenericResponse';
        $request = $this->sendAdvMailRequest($subject, $body, $from, $to, $replyto, $cc, $bcc, $attachments, $id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function sendAdvMailRequest($subject, $body, $from, $to, $replyto, $cc, $bcc, $attachments, $id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function sendMailRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function viewMailLog($id = null, $search = null, $skip = '0', $limit = '100', $startDate = null, $endDate = null)
    {
        list($response) = $this->viewMailLogWithHttpInfo($id, $search, $skip, $limit, $startDate, $endDate);
        return $response;
    }
     ...
     */
    public function viewMailLogWithHttpInfo($id = null, $search = null, $skip = '0', $limit = '100', $startDate = null, $endDate = null)
    {
        $returnType = '\Interserver\Mailbaby\Model\MailLog';
        $request = $this->viewMailLogRequest($id, $search, $skip, $limit, $startDate, $endDate);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function viewMailLogAsync($id = null, $search = null, $skip = '0', $limit = '100', $startDate = null, $endDate = null)
    {
        return $this->viewMailLogAsyncWithHttpInfo($id, $search, $skip, $limit, $startDate, $endDate)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function viewMailLogAsyncWithHttpInfo($id = null, $search = null, $skip = '0', $limit = '100', $startDate = null, $endDate = null)
    {
        $returnType = '\Interserver\Mailbaby\Model\MailLog';
        $request = $this->viewMailLogRequest($id, $search, $skip, $limit, $startDate, $endDate);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function viewMailLogRequest($id = null, $search = null, $skip = '0', $limit = '100', $startDate = null, $endDate = null)
    {
