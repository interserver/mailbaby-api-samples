...
/**
     ...
     * @param  \Interserver\Mailbaby\Model\EmailAddressesTypes $replyto replyto (optional)
     * @param  \Interserver\Mailbaby\Model\EmailAddressesTypes $cc cc (optional)
     * @param  \Interserver\Mailbaby\Model\EmailAddressesTypes $bcc bcc (optional)
     ...
     * @param  \Interserver\Mailbaby\Model\EmailAddressesTypes $replyto (optional)
     * @param  \Interserver\Mailbaby\Model\EmailAddressesTypes $cc (optional)
     * @param  \Interserver\Mailbaby\Model\EmailAddressesTypes $bcc (optional)
     * @param  \Interserver\Mailbaby\Model\MailAttachment[] $attachments (optional) File attachments to include in the email.  The file contents must be base64 encoded! (optional)
     * @param  int $id (optional)  ID of the Mail order within our system to use as the Mail Account. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['sendAdvMail'] to see the possible values for this operation
     *
