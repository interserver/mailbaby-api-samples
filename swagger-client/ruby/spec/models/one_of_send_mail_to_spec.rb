...
# Unit tests for SwaggerClient::OneOfSendMailTo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OneOfSendMailTo' do
  before do
    # run before each test
    @instance = SwaggerClient::OneOfSendMailTo.new
  end
  ...
  describe 'test an instance of OneOfSendMailTo' do
    it 'should create an instance of OneOfSendMailTo' do
      expect(@instance).to be_instance_of(SwaggerClient::OneOfSendMailTo)
    end
  end
end
