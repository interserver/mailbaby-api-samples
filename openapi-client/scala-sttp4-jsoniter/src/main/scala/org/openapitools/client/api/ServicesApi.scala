...
case class ServicesApi[Auth <: org.openapitools.client.core.Authorization] private (baseUrl: String, authConfig: org.openapitools.client.core.Authorization):
   ...
   */
  def getMailOrderById(id: Long)(using Auth <:< org.openapitools.client.core.Authorization.ApiKey): sttp.client4.Request[Either[ResponseException[String], MailOrderDetail]] =
    ...
    basicRequest
      ...
      .response(asJson[MailOrderDetail])
