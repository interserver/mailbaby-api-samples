...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaResteasyServerCodegen", date = "2021-05-05T04:03:25.201844-04:00[America/New_York]")public class MailApi  {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "404", description = "The specified resource was not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class))) })
    public Response sendMailById(@Parameter(description = "", required=true)@FormParam("payload")  SendMail payload,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.sendMailById(payload,securityContext);
    }
    @GET
    @Path("/order")
