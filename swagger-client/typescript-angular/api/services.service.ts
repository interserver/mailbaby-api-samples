...
export class ServicesService {
     ...
     */
    public getMailOrderById(id: number, observe?: 'body', reportProgress?: boolean): Observable<MailOrderDetail>;
    public getMailOrderById(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<MailOrderDetail>>;
    public getMailOrderById(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<MailOrderDetail>>;
    public getMailOrderById(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<MailOrderDetail>('get',`${this.basePath}/mail/${encodeURIComponent(String(id))}`,
            {
