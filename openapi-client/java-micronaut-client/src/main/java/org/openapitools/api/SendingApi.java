...
public interface SendingApi {
     ...
     * @param _body The email body.  If the string contains any HTML tags the message is automatically sent as &#x60;text/html&#x60;; otherwise it is sent as &#x60;text/plain&#x60;. (required)
     * @param from  (required)
     * @param to  (required)
