...
OAIEmailAddressTypes OAISendMailAdv::getFrom() const {
    return m_from;
}
void OAISendMailAdv::setFrom(const OAIEmailAddressTypes &from) {
    m_from = from;
    m_from_isSet = true;
}
...
OAIEmailAddressesTypes OAISendMailAdv::getTo() const {
    return m_to;
}
void OAISendMailAdv::setTo(const OAIEmailAddressesTypes &to) {
    m_to = to;
    m_to_isSet = true;
}
...
OAIEmailAddressesTypes OAISendMailAdv::getReplyto() const {
    return m_replyto;
}
void OAISendMailAdv::setReplyto(const OAIEmailAddressesTypes &replyto) {
    m_replyto = replyto;
...
OAIEmailAddressesTypes OAISendMailAdv::getCc() const {
    return m_cc;
}
void OAISendMailAdv::setCc(const OAIEmailAddressesTypes &cc) {
    m_cc = cc;
    m_cc_isSet = true;
}
...
OAIEmailAddressesTypes OAISendMailAdv::getBcc() const {
    return m_bcc;
}
void OAISendMailAdv::setBcc(const OAIEmailAddressesTypes &bcc) {
    m_bcc = bcc;
    m_bcc_isSet = true;
}
