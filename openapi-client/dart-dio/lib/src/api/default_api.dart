...
class DefaultApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<GetMailOrders200ResponseInner>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<GetMailOrders200ResponseInner>>> getMailOrders({ 
    ...
    BuiltList<GetMailOrders200ResponseInner> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(GetMailOrders200ResponseInner)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as BuiltList<GetMailOrders200ResponseInner>;
    ...
    return Response<BuiltList<GetMailOrders200ResponseInner>>(
      data: _responseData,
  ...
  Future<Response<GenericResponse>> sendAdvMail({ 
    required SendMailAdv sendMailAdv,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<MailLog>> viewMailLog({ 
    ...
    try {
      const _responseType = FullType(MailLog);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as MailLog;
