...
#ifndef OAISendMailTo_H
#define OAISendMailTo_H
...
class OAISendMailTo : public OAIObject {
public:
    OAISendMailTo();
    OAISendMailTo(QString json);
    ~OAISendMailTo() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAISendMailTo)

#endif // OAISendMailTo_H
