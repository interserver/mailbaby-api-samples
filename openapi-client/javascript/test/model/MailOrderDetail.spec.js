...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MailBabyEmailDeliveryAndManagementServiceApi.MailOrderDetail();
  });
  ...
  describe('MailOrderDetail', function() {
    it('should create an instance of MailOrderDetail', function() {
      // uncomment below and update the code to test MailOrderDetail
      //var instance = new MailBabyEmailDeliveryAndManagementServiceApi.MailOrderDetail();
      //expect(instance).to.be.a(MailBabyEmailDeliveryAndManagementServiceApi.MailOrderDetail);
    });
