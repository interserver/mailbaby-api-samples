...
import six
from mailbaby-client-python.models.mail_order import MailOrder  # noqa: F401,E501

class MailOrderDetail(MailOrder):
    ...
    if hasattr(MailOrder, "swagger_types"):
        swagger_types.update(MailOrder.swagger_types)

    attribute_map = {
        'password': 'password'
    }
    if hasattr(MailOrder, "attribute_map"):
        attribute_map.update(MailOrder.attribute_map)

    def __init__(self, password=None, *args, **kwargs):  # noqa: E501
        """MailOrderDetail - a model defined in Swagger"""  # noqa: E501
        self._password = None
        self.discriminator = None
        self.password = password
        MailOrder.__init__(self, *args, **kwargs)

    @property
    def password(self):
        """Gets the password of this MailOrderDetail.  # noqa: E501
        ...
        :return: The password of this MailOrderDetail.  # noqa: E501
        :rtype: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MailOrderDetail, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MailOrderDetail):
            return False
