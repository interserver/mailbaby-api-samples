...
# Unit tests for SwaggerClient::MailOrderDetail
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MailOrderDetail' do
  before do
    # run before each test
    @instance = SwaggerClient::MailOrderDetail.new
  end
  ...
  describe 'test an instance of MailOrderDetail' do
    it 'should create an instance of MailOrderDetail' do
      expect(@instance).to be_instance_of(SwaggerClient::MailOrderDetail)
    end
  end
