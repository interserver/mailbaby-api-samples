...
class BlockingApi:
    ...
    def add_rule(
        ...
        **kwargs,
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the add_rule_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        return self.add_rule_with_http_info.raw_function(
            type,
            data,
            user,
            **kwargs,
    ...
    def add_rule_with_http_info(
        ...
        **kwargs,
        ...
        _auth_settings: List[str] = ['apiKeyAuth']  # noqa: E501
    ...
    def delete_rule(
        ...
        **kwargs,
        ...
        return self.delete_rule_with_http_info.raw_function(
            rule_id,
            **kwargs,
        )
    ...
    def delete_rule_with_http_info(
        ...
        **kwargs,
        ...
        # process the path parameters
        _path_params: Dict[str, str] = {}
        if _params['rule_id'] is not None:
    ...
    def delist_block(
        ...
        **kwargs,
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delist_block_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        return self.delist_block_with_http_info.raw_function(
            body,
            **kwargs,
        )
    ...
    def get_mail_blocks(
        ...
        **kwargs,
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_mail_blocks_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        return self.get_mail_blocks_with_http_info.raw_function(
            **kwargs,
        )
    ...
    def get_rules(
        ...
        **kwargs,
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_rules_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)

        return self.get_rules_with_http_info.raw_function(
            **kwargs,
        )
