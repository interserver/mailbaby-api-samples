...
export function SendMailToFromJSON(json: any): SendMailTo {
    return SendMailToFromJSONTyped(json, false);
}

export function SendMailToFromJSONTyped(json: any, ignoreDiscriminator: boolean): SendMailTo {
    if (json == null) {
        return json;
    }
...
export function SendMailToToJSON(json: any): any {
    return SendMailToToJSONTyped(json, false);
}

export function SendMailToToJSONTyped(value?: SendMailTo | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
