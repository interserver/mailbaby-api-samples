...
#
package OpenAPIClient::Object::EmailAddressNames;
...
__PACKAGE__->class_documentation({description => 'An array of email contacts, each with an email address and optional display name.',
