...
/**
 * Check if a given object implements the MailStatsVolume interface.
 */
export function instanceOfMailStatsVolume(value: object): value is MailStatsVolume {
    return true;
}

export function MailStatsVolumeFromJSON(json: any): MailStatsVolume {
    return MailStatsVolumeFromJSONTyped(json, false);
}

export function MailStatsVolumeFromJSONTyped(json: any, ignoreDiscriminator: boolean): MailStatsVolume {
    if (json == null) {
        return json;
    }
    return {
...
export function MailStatsVolumeToJSON(json: any): MailStatsVolume {
    return MailStatsVolumeToJSONTyped(json, false);
}

export function MailStatsVolumeToJSONTyped(value?: MailStatsVolume | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
