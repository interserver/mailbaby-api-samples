...
module SwaggerClient
  class ServicesApi
    ...
    def get_mail_order_by_id(id, opts = {})
      data, _status_code, _headers = get_mail_order_by_id_with_http_info(id, opts)
      data
    end
    ...
    def get_mail_order_by_id_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ServicesApi.get_mail_order_by_id ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling ServicesApi.get_mail_order_by_id"
      end
      # resource path
      ...
      return_type = opts[:return_type] || 'MailOrderDetail' 
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ServicesApi#get_mail_order_by_id\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
