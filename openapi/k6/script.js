...
export default function() {
    ...
    group("/mail/{id}/advsend", () => {
        ...
        // Request No. 1
        // TODO: edit the parameters of the request body.
        let body = {"id": "long", "from": {"email": "string", "name": "string"}, "to": [{"email": "string", "name": "string"}], "subject": "string", "body": "string", "replyto": [{"email": "string", "name": "string"}], "cc": [{"email": "string", "name": "string"}], "bcc": [{"email": "string", "name": "string"}], "attachments": [{"filename": "string", "data": "file"}]};
