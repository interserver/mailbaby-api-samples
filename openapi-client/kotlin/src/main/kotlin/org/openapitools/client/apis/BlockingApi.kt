...
open class BlockingApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun delistBlock(emailAddressParam: EmailAddressParam) : GenericResponse {
        val localVarResponse = delistBlockWithHttpInfo(emailAddressParam = emailAddressParam)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun delistBlockWithHttpInfo(emailAddressParam: EmailAddressParam) : ApiResponse<GenericResponse?> {
        val localVariableConfig = delistBlockRequestConfig(emailAddressParam = emailAddressParam)

        return request<EmailAddressParam, GenericResponse>(
            localVariableConfig
        )
    }
     ...
     * @return RequestConfig
     */
    fun delistBlockRequestConfig(emailAddressParam: EmailAddressParam) : RequestConfig<EmailAddressParam> {
        val localVariableBody = emailAddressParam
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
