...
MailStatsTypeVolume <- R6::R6Class(
  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`to`)) {
        MailStatsTypeVolumeObject[['to']] <- self$`to`
      }
      if (!is.null(self$`from`)) {
        MailStatsTypeVolumeObject[['from']] <- self$`from`
      }
      if (!is.null(self$`ip`)) {
        MailStatsTypeVolumeObject[['ip']] <- self$`ip`
      }
    ...
    fromJSON = function(MailStatsTypeVolumeJson) {
      ...
      if (!is.null(MailStatsTypeVolumeObject$`to`)) {
        self$`to` <- MailStatsTypeVolumeObject$`to`
      }
      if (!is.null(MailStatsTypeVolumeObject$`from`)) {
        self$`from` <- MailStatsTypeVolumeObject$`from`
      }
      if (!is.null(MailStatsTypeVolumeObject$`ip`)) {
        self$`ip` <- MailStatsTypeVolumeObject$`ip`
      }
    },
