...
export const DefaultApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        viewMailLog(id?: number, search?: string, skip?: number, limit?: number, options: RequestOptions): FetchArgs {
...
export type DefaultApiType = { 
    ...
    viewMailLog(id?: number, search?: string, skip?: number, limit?: number, options?: RequestOptions): Promise<MailLog>,
}
...
export const DefaultApi = function(configuration?: Configuration, fetch: FetchAPI = portableFetch): DefaultApiType {
    ...
    return {
         ...
         */
        viewMailLog(id?: number, search?: string, skip?: number, limit?: number, options?: RequestOptions = {}): Promise<MailLog> {
            const localVarFetchArgs = DefaultApiFetchParamCreator(configuration).viewMailLog(id, search, skip, limit, options);
            return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                if (response.status >= 200 && response.status < 300) {
                    return response.json();
                } else {
