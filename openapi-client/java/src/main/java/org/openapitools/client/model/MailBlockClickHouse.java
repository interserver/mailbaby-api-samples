...
public class MailBlockClickHouse {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("date", "from", "messageId", "subject", "to"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("date", "from", "messageId", "subject", "to"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MailBlockClickHouse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in MailBlockClickHouse is not found in the empty JSON string", MailBlockClickHouse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MailBlockClickHouse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MailBlockClickHouse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
