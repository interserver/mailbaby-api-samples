...
export class BlockingService {
     ...
     */
    public delistBlock(emailAddressParam: EmailAddressParam, observe?: 'body', headers?: Headers): Observable<GenericResponse>;
    public delistBlock(emailAddressParam: EmailAddressParam, observe?: 'response', headers?: Headers): Observable<HttpResponse<GenericResponse>>;
    public delistBlock(emailAddressParam: EmailAddressParam, observe: any = 'body', headers: Headers = {}): Observable<any> {
        ...
        const response: Observable<HttpResponse<GenericResponse>> = this.httpClient.post(`${this.basePath}/mail/blocks/delete`, emailAddressParam , headers);
        if (observe === 'body') {
               return response.pipe(
                   map((httpResponse: HttpResponse) => <GenericResponse>(httpResponse.response))
               );
