...
class DefaultApi
{
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function viewMailLogRequest($id = null, $search = null, $skip = 0, $limit = 100, $startDate = null, $endDate = null)
    {
        if ($skip !== null && $skip < 0) {
        ...
        if ($startDate !== null && $startDate > 9999999999) {
            throw new \InvalidArgumentException('invalid value for "$startDate" when calling DefaultApi.viewMailLog, must be smaller than or equal to 9999999999.');
        }
        if ($startDate !== null && $startDate < 0) {
            throw new \InvalidArgumentException('invalid value for "$startDate" when calling DefaultApi.viewMailLog, must be bigger than or equal to 0.');
        }

        if ($endDate !== null && $endDate > 9999999999) {
            throw new \InvalidArgumentException('invalid value for "$endDate" when calling DefaultApi.viewMailLog, must be smaller than or equal to 9999999999.');
        }
        if ($endDate !== null && $endDate < 0) {
            throw new \InvalidArgumentException('invalid value for "$endDate" when calling DefaultApi.viewMailLog, must be bigger than or equal to 0.');
        }
