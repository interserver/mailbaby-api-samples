...
# Unit tests for SwaggerClient::MailStatsType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MailStatsType' do
  before do
    # run before each test
    @instance = SwaggerClient::MailStatsType.new
  end
  ...
  describe 'test an instance of MailStatsType' do
    it 'should create an instance of MailStatsType' do
      expect(@instance).to be_instance_of(SwaggerClient::MailStatsType)
    end
  end
  describe 'test attribute "time"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["all", "billing", "month", "7d", "24h", "day", "1h"])
