...
@return GenericResponse
*/
func (a *SendingApiService) SendMail(ctx context.Context, to SendMailTo, from string, subject string, body string, id int64) (GenericResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
